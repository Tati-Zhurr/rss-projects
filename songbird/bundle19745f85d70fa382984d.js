...
var birdsDataEnglish = [[{
  ...
  name: 'Song thrush',
  species: 'Turdus philomelos',
  description: 'Drozd is the best singer from the sparrow squad. The song consists only of beautiful sonorous whistles and short trills. Most often it can be heard in the morning and evening. Thrushes sing during the entire nesting period.',
  image: 'https://live.staticflickr.com/65535/48979125763_e2534f54bd.jpg',
  audio: 'https://www.xeno-canto.org/sounds/uploaded/BLMSIUFTFU/XC513326-190704_1146_TF-Glogow.mp3'
}, {
  id: 5,
  ...
  name: 'Hoopoe',
  species: 'Upupa epops',
  description: 'Hoopoe prefer to live in open landscapes with individual trees or groves. The most convenient for the bird are the forest-steppe and savannah. A hoopoe can choose a place of residence next to a person: pastures, vineyards, orchards.',
  image: 'https://live.staticflickr.com//65535//49226383598_6f8be86a06.jpg',
  audio: 'https://www.xeno-canto.org/sounds/uploaded/ZNCDXTUOFL/XC477326-dudek%20%282%29.mp3'
}, {
  id: 6,
  ...
  name: 'Gannet',
  species: 'Sula nebouxii',
  description: 'A feature of the blue-footed booby is not only the rich bright blue color of the legs, but also the fact that they are very warm. While other species of birds warm the clutches with their bodies, the blue-footed booby does this with the help of its paws.',
  image: 'https://live.staticflickr.com/800/40645471394_4422e69ed8.jpg',
  audio: 'https://www.xeno-canto.org/sounds/uploaded/YHKQPPJDVP/XC411507-171217_1491%20BF%20Booby%205ft%20IDLP%201230%20mp3%20amp.mp3'
}, {
  id: 3,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (birdsDataEnglish);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (birdsDataGalleryEnglish);

/***/ }),

/***/ "./src/changeLanguageMainPage.js":
/*!***************************************!*\
  !*** ./src/changeLanguageMainPage.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function changeLanguageMainPage(lang) {
  var buttonNavPlay = document.querySelector('.button__nav');
  var langImg = document.querySelector('.img_lang');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (changeLanguageMainPage);

/***/ }),

/***/ "./src/changeLanguageplayPage.js":
/*!***************************************!*\
  !*** ./src/changeLanguageplayPage.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function changeLanguagePlayPage(lang) {
  var langImg = document.querySelector('.img_lang');
  var playButtonNext = document.querySelector('.play__button_next');
  var scoreText = document.querySelector('.score_text');
  var instructions = document.querySelector('.instructions');
  var categorigies = document.querySelector('.categories-block');
  var allCategorigiesEng = ['Warming-up', 'Passerines', 'Forest birds', 'Songbirds', 'Predator birds', 'Sea birds'];
  var allCategorigies = ['Разминка', 'Воробьиные', 'Лесные птицы', 'Певчие птицы', 'Хищные птицы', 'Морские птицы'];
  ...
  if (lang) {
    ...
    for (var _i = 0; _i < 6; _i++) {
      categorigies.childNodes[_i].textContent = allCategorigies[_i];
    }
  }
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (changeLanguagePlayPage);
...
function changeVolume(button, audio) {
  var barVolume = button.nextElementSibling;
  ...
  barVolume.onmousedown = function (event) {
    ...
    function onMouseMove(event) {
      var newLeft = event.clientX - barVolume.getBoundingClientRect().left; // the pointer is out of slider => lock the thumb within the bounaries

      if (newLeft < 0) {
        newLeft = 0;
      }

      var rightEdge = barVolume.offsetWidth;

      if (newLeft > rightEdge) {
        newLeft = rightEdge;
      }

      var progressVolume = newLeft / barVolume.offsetWidth;
      var newVolumeAudio = progressVolume;
      audio.volume = newVolumeAudio;
      barVolume.style.background = "linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) ".concat(progressVolume * 100, "%, #f0c592 2.90146%, #c93a3d 100%)");
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (changeVolume);
...
/* harmony import */ var _birdsEnglish__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./birdsEnglish */ "./src/birdsEnglish.js");



function getAnswers(level, lang) {
  var answerList = document.querySelectorAll('.answer-text');

  if (lang) {
    answerList.forEach(function (e, i) {
      e.textContent = _birdsEnglish__WEBPACK_IMPORTED_MODULE_1__["default"][level][i].name;
    });
  } else {
    answerList.forEach(function (e, i) {
      e.textContent = _birds__WEBPACK_IMPORTED_MODULE_0__["default"][level][i].name;
    });
  }
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getAnswers);

/***/ }),

/***/ "./src/getAudioReset.js":
/*!******************************!*\
  !*** ./src/getAudioReset.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getAudioReset);
...
function getBirdCard(cardId, level, lang) {
  ...
  var birdName = document.querySelector('.bird-name');
  var latinName = document.querySelector('.species');
  var birdDescription = document.querySelector('.bird-description');

  if (lang) {
    imgBird.src = _birdsEnglish__WEBPACK_IMPORTED_MODULE_1__["default"][level][cardId].image;
    birdName.textContent = _birdsEnglish__WEBPACK_IMPORTED_MODULE_1__["default"][level][cardId].name;
    latinName.textContent = _birdsEnglish__WEBPACK_IMPORTED_MODULE_1__["default"][level][cardId].species;
    birdDescription.textContent = _birdsEnglish__WEBPACK_IMPORTED_MODULE_1__["default"][level][cardId].description;
  } else {
    imgBird.src = _birds__WEBPACK_IMPORTED_MODULE_0__["default"][level][cardId].image;
    birdName.textContent = _birds__WEBPACK_IMPORTED_MODULE_0__["default"][level][cardId].name;
    latinName.textContent = _birds__WEBPACK_IMPORTED_MODULE_0__["default"][level][cardId].species;
    birdDescription.textContent = _birds__WEBPACK_IMPORTED_MODULE_0__["default"][level][cardId].description;
  }
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getBirdCard);

/***/ }),

/***/ "./src/getBirdToGuess.js":
/*!*******************************!*\
  !*** ./src/getBirdToGuess.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getBirdToGuess(level, lang) {
  ...
  if (lang) {
    birdHidden = _birdsEnglish__WEBPACK_IMPORTED_MODULE_1__["default"][level][randomNumber];
  } else {
    birdHidden = _birds__WEBPACK_IMPORTED_MODULE_0__["default"][level][randomNumber];
  }

  return birdHidden;
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getBirdToGuess);

/***/ }),

/***/ "./src/getButtonColorChanged.js":
/*!**************************************!*\
  !*** ./src/getButtonColorChanged.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getButtonColorChanged() {
  var buttonPlay = document.querySelector('.button__nav_play');
  buttonPlay.classList.toggle('press');
  setTimeout(getButtonColorChanged, 1000);
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getButtonColorChanged);

/***/ }),

/***/ "./src/getHiddenBirdCard.js":
/*!**********************************!*\
  !*** ./src/getHiddenBirdCard.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var imgBird = document.querySelector('.img-guess');
var nameBird = document.querySelector('.name-guess');

function getHiddenBirdCard(birdHidden) {
  imgBird.style.backgroundImage = "url(".concat(birdHidden.image, ")");
  nameBird.textContent = birdHidden.name;
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getHiddenBirdCard);

/***/ }),

/***/ "./src/getTimeFromNum.js":
/*!*******************************!*\
  !*** ./src/getTimeFromNum.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getTimeFromNum(currentTimeStr) {
  var currentTimeNum = parseInt(currentTimeStr);
  var minutes = parseInt(currentTimeNum / 60);
  var seconds = currentTimeNum % 60;
  return "".concat(String(minutes).padStart(2, 0), ":").concat(String(seconds).padStart(2, 0));
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getTimeFromNum);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (hideNewBird);
...
/* harmony import */ var _getButtonColorChanged__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getButtonColorChanged */ "./src/getButtonColorChanged.js");
/* harmony import */ var _getBirdToGuess__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getBirdToGuess */ "./src/getBirdToGuess.js");
/* harmony import */ var _getAnswers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getAnswers */ "./src/getAnswers.js");
/* harmony import */ var _playAudio__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./playAudio */ "./src/playAudio.js");
/* harmony import */ var _getBirdCard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./getBirdCard */ "./src/getBirdCard.js");
/* harmony import */ var _isCorrectAnswer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./isCorrectAnswer */ "./src/isCorrectAnswer.js");
/* harmony import */ var _playAudioCard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./playAudioCard */ "./src/playAudioCard.js");
/* harmony import */ var _getAudioReset__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./getAudioReset */ "./src/getAudioReset.js");
/* harmony import */ var _getHiddenBirdCard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./getHiddenBirdCard */ "./src/getHiddenBirdCard.js");
/* harmony import */ var _showResults__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./showResults */ "./src/showResults.js");
/* harmony import */ var _hideNewBird__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hideNewBird */ "./src/hideNewBird.js");
/* harmony import */ var _resetForNewGame__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./resetForNewGame */ "./src/resetForNewGame.js");
/* harmony import */ var _progressAudio__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./progressAudio */ "./src/progressAudio.js");
/* harmony import */ var _myComment__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./myComment */ "./src/myComment.js");
/* harmony import */ var _changeLanguageMainPage__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./changeLanguageMainPage */ "./src/changeLanguageMainPage.js");
/* harmony import */ var _changeLanguageplayPage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./changeLanguageplayPage */ "./src/changeLanguageplayPage.js");
/* harmony import */ var _changeVolume__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./changeVolume */ "./src/changeVolume.js");
/* harmony import */ var _moveThumbAudio__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./moveThumbAudio */ "./src/moveThumbAudio.js");
/* harmony import */ var _playAudioGallery__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./playAudioGallery */ "./src/playAudioGallery.js");
/* harmony import */ var _stopPrevAudio__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./stopPrevAudio */ "./src/stopPrevAudio.js");
/* harmony import */ var _birdsGallery__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./birdsGallery */ "./src/birdsGallery.js");
...
var buttonOn = document.querySelector('.start__button_sound');
var soundHens = new Audio('Hens_song.mp3');
var langButton = document.querySelector('.img_lang');
var lang = true; //English
...
if (buttonOn) {
  ...
  var getLocalStorage = function getLocalStorage() {
    if (localStorage.getItem('lang')) {
      ...
      (0,_changeLanguageMainPage__WEBPACK_IMPORTED_MODULE_16__["default"])(lang);
    }
  };
  ...
  buttonOn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  (0,_getButtonColorChanged__WEBPACK_IMPORTED_MODULE_2__["default"])();
  ;
  ;
...
if (document.querySelector('.play')) {
  var resetForNextLevel = function resetForNextLevel(level) {
    if (level === 0) {
    ...
    var indicators = document.querySelectorAll('.answer-indicator');
    scoreLevel = 5;
    birdHidden = (0,_getBirdToGuess__WEBPACK_IMPORTED_MODULE_3__["default"])(level, lang);
    (0,_getAnswers__WEBPACK_IMPORTED_MODULE_4__["default"])(level, lang);
    (0,_hideNewBird__WEBPACK_IMPORTED_MODULE_12__["default"])();
    cardBird.classList.add('hidden');
    instructions.classList.remove('hidden');
    nextLevelButton.classList.remove('active');

    var _iterator = _createForOfIteratorHelper(indicators),
        _step;
  ...
  var _setLocalStorage = function _setLocalStorage() {
    localStorage.setItem('lang', lang);
  };

  var _getLocalStorage = function _getLocalStorage() {
    if (localStorage.getItem('lang')) {
      if (localStorage.getItem('lang') === 'true') {
        lang = true;
      } else {
      ...
      (0,_changeLanguageplayPage__WEBPACK_IMPORTED_MODULE_17__["default"])(lang);
      (0,_getAnswers__WEBPACK_IMPORTED_MODULE_4__["default"])(level, lang);
    }
  };
  ...
  var score = 0;
  var scoreLevel = 5;
  var birdHidden = (0,_getBirdToGuess__WEBPACK_IMPORTED_MODULE_3__["default"])(level, lang);
  (0,_getAnswers__WEBPACK_IMPORTED_MODULE_4__["default"])(level, lang);
  var audio = new Audio();
  var playButton = document.querySelector(".guess__playback-button");
  var isPlay = false;
  langButton.addEventListener('click', function () {
    lang = !lang;
    (0,_changeLanguageplayPage__WEBPACK_IMPORTED_MODULE_17__["default"])(lang);
    ...
    if (cardId) {
      (0,_getBirdCard__WEBPACK_IMPORTED_MODULE_6__["default"])(cardId, level, lang);
    }
  });
  playButton.addEventListener("click", function () {
    (0,_playAudio__WEBPACK_IMPORTED_MODULE_5__["default"])(birdHidden, audio, isPlay);
    isPlay = !isPlay;
  });
  var cardBird = document.querySelector('.card-body');
  var instructions = document.querySelector('.instructions');
  var answerList = document.querySelector('.answer-list');
  var nextLevelButton = document.querySelector('.play__button_next');
  var actualScore = document.querySelector('.score_actual');
  var levelNameList = document.querySelector('.categories-block');
  var cardId;
  var answerCorrect;
  var audioCard = new Audio();
  answerList.addEventListener('click', function (el) {
    ...
    if (!answerCorrect && !nextLevelButton.classList.contains('active')) {
      answerCorrect = (0,_isCorrectAnswer__WEBPACK_IMPORTED_MODULE_7__["default"])(birdHidden, answerItem, cardId);
    }

    audioCard.src = _birds__WEBPACK_IMPORTED_MODULE_1__["default"][level][cardId].audio;
    (0,_getBirdCard__WEBPACK_IMPORTED_MODULE_6__["default"])(cardId, level, lang);

    if (answerCorrect) {
      score = score + scoreLevel;
      actualScore.textContent = "".concat(score);
      (0,_getAudioReset__WEBPACK_IMPORTED_MODULE_9__["default"])(audio, playButton, isPlay);
      (0,_getAudioReset__WEBPACK_IMPORTED_MODULE_9__["default"])(audioCard, playButtonCard, isPlay2);
      (0,_getHiddenBirdCard__WEBPACK_IMPORTED_MODULE_10__["default"])(birdHidden);
      answerCorrect = false;

      if (level === 5) {
        (0,_showResults__WEBPACK_IMPORTED_MODULE_11__["default"])(score, lang);
      } else {
  ...
  nextLevelButton.addEventListener('click', function () {
    if (nextLevelButton.classList.contains('active')) {
      ...
      scoreLevel = 5;
      birdHidden = (0,_getBirdToGuess__WEBPACK_IMPORTED_MODULE_3__["default"])(level, lang);
      (0,_resetForNewGame__WEBPACK_IMPORTED_MODULE_13__["default"])();
      (0,_getAnswers__WEBPACK_IMPORTED_MODULE_4__["default"])(level, lang);
      (0,_hideNewBird__WEBPACK_IMPORTED_MODULE_12__["default"])();
      resetForNextLevel(level);
      actualScore.textContent = "".concat(score);
  ...
  var playButtonCard = document.querySelector(".card__playback-button");
  var isPlay2 = false;

  if (playButtonCard) {
    playButtonCard.addEventListener('click', function () {
      (0,_playAudioCard__WEBPACK_IMPORTED_MODULE_8__["default"])(level, cardId, isPlay2, audioCard);
      isPlay2 = !isPlay2;
    });
  }

  audioCard.addEventListener('ended', function () {
  ...
  var block = document.querySelector('.block-guess');
  var buttonVolume = block.querySelector('.button__img_volume');
  var blockSelect = document.querySelector('.select');
  var timeBarSelect = blockSelect.querySelector('.timebar');
  var buttonVolumeSelect = blockSelect.querySelector('.button__img_volume');

  timeBar.onmousedown = function (event) {
    (0,_moveThumbAudio__WEBPACK_IMPORTED_MODULE_19__["default"])(event, block, isPlay, audio);
  };

  if (timeBarSelect) {
    timeBarSelect.onmousedown = function (event) {
      (0,_moveThumbAudio__WEBPACK_IMPORTED_MODULE_19__["default"])(event, blockSelect, isPlay2, audioCard);
    };
  }

  ;
  buttonVolume.addEventListener('click', function (event) {
    (0,_changeVolume__WEBPACK_IMPORTED_MODULE_18__["default"])(buttonVolume, audio);
  });
  buttonVolumeSelect.addEventListener('click', function (event) {
    (0,_changeVolume__WEBPACK_IMPORTED_MODULE_18__["default"])(buttonVolumeSelect, audioCard);
  });
  setInterval(function () {
    (0,_progressAudio__WEBPACK_IMPORTED_MODULE_14__["default"])(audio, block);
  }, 300);
  setInterval(function () {
    (0,_progressAudio__WEBPACK_IMPORTED_MODULE_14__["default"])(audioCard, blockSelect);
  }, 300); //language

  window.addEventListener('beforeunload', _setLocalStorage);
  window.addEventListener('load', _getLocalStorage);
  ;
  ;
}
...
if (gallery) {
  var _isPlay = false;
  var audioBird = new Audio();
  var buttonPlay;
  var blockBird;
  var birdImg = gallery.querySelector('.img-bird');
  var bird = gallery.querySelector('.bird');
  var birdName = gallery.querySelector('.bird-name');
  var latinName = gallery.querySelector('.species');
  var birdDescription = gallery.querySelector('.bird-description');
  birdImg.src = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][0].image;
  birdName.textContent = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][0].name;
  latinName.textContent = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][0].species;
  birdDescription.textContent = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][0].description;

  for (var i = 2; i < _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"].length + 1; i++) {
    var nextBird = bird.cloneNode(true);
    var nextBirdImg = nextBird.querySelector('.img-bird');
    var nextBirdName = nextBird.querySelector('.bird-name');
    var nextBirdLatinName = nextBird.querySelector('.species');
    var nextBirdDescription = nextBird.querySelector('.bird-description');
    nextBirdImg.src = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][i - 1].image;
    nextBirdName.textContent = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][i - 1].name;
    nextBirdLatinName.textContent = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][i - 1].species;
    nextBirdDescription.textContent = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][i - 1].description;
    gallery.append(nextBird);
    nextBird.id = "".concat(i);
  }

  audioBird.addEventListener('ended', function () {
  ...
  gallery.addEventListener('click', function (event) {
    if (event.target.classList.contains('button__img_volume')) {
      ...
      (0,_changeVolume__WEBPACK_IMPORTED_MODULE_18__["default"])(button, audioBird);
    } else if (event.target.classList.contains('button__img_sound')) {
      if (event.target !== buttonPlay) {
        setInterval(function () {
          (0,_progressAudio__WEBPACK_IMPORTED_MODULE_14__["default"])(audioBird, blockBird);
        }, 300);
        (0,_stopPrevAudio__WEBPACK_IMPORTED_MODULE_21__["default"])(buttonPlay, blockBird, audioBird);
      }

      ;
      buttonPlay = event.target;
      blockBird = buttonPlay.closest('.bird');
      var idBird = blockBird.id;
      var audioBirdSource = _birdsGallery__WEBPACK_IMPORTED_MODULE_22__["default"][idBird - 1].audio;
      (0,_playAudioGallery__WEBPACK_IMPORTED_MODULE_20__["default"])(audioBirdSource, audioBird, _isPlay, blockBird);
      _isPlay = !_isPlay;
    }
  });
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var soundFailed = new Audio('Rooster-Clucks.mp3');
var soundCorrect = new Audio('Rooster-sound.mp3');

function isCorrectAnswer(birdHidden, el, cardId) {
  var answerSelected = el;
  var indicator = answerSelected.firstChild;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (isCorrectAnswer);

/***/ }),

/***/ "./src/moveThumbAudio.js":
/*!*******************************!*\
  !*** ./src/moveThumbAudio.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function moveThumbAudio(event, block, isPlay, audioPlaying) {
  var thumb = block.querySelector('.timebar-circle');
  var timeBar = block.querySelector('.timebar');
  var progress = block.querySelector('.timebar-bar');

  if (isPlay) {
    var onMouseMove = function onMouseMove(event) {
      var newLeft = event.clientX - shiftX - timeBar.getBoundingClientRect().left; // the pointer is out of slider => lock the thumb within the bounaries

      if (newLeft < 0) {
        newLeft = 0;
      }

      var rightEdge = timeBar.offsetWidth - thumb.offsetWidth;
      ...
      var progressValue = newLeft / timeBar.offsetWidth;
      var newTimeAudio = progressValue * audioPlaying.duration;
      audioPlaying.currentTime = newTimeAudio;
      progress.style.background = "linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) ".concat(progressValue * 100, "%, #f0c592 2.90146%, #c93a3d 100%)");
    };
    ...
    var shiftX = event.clientX - thumb.getBoundingClientRect().left; // shiftY not needed, the thumb moves only horizontally
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (moveThumbAudio);
...
/* harmony import */ var _progressAudio__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./progressAudio */ "./src/progressAudio.js");
/* harmony import */ var _getTimeFromNum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getTimeFromNum */ "./src/getTimeFromNum.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function playAudio(_x, _x2, _x3) {
  return _playAudio.apply(this, arguments);
}

function _playAudio() {
  _playAudio = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(birdHidden, audio, isPlay) {
    var currentTime, thumb, progressBar, duration;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            currentTime = block.querySelector('.current-time');
            thumb = block.querySelector('.timebar-circle');
            progressBar = block.querySelector('.timebar-bar');
            ...
            _context.next = 7;
            return birdHidden.audio;

          case 7:
            audio.src = _context.sent;
            audio.currentTime = 0;
            audio.play(); // isPlay = true;

            playButton.classList.add("pause");
            audio.addEventListener("loadeddata", function () {
              duration.textContent = "".concat((0,_getTimeFromNum__WEBPACK_IMPORTED_MODULE_2__["default"])(audio.duration));
              audio.volume = 0.75;
            }, false);
            duration.textContent = "".concat((0,_getTimeFromNum__WEBPACK_IMPORTED_MODULE_2__["default"])(audio.duration));
            _context.next = 16;
          ...
          case 15:
            if (isPlay) {
              ...
              thumb.style.left = '0%';
              duration.textContent = '00:00'; // isPlay = false;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (playAudio);

/***/ }),

/***/ "./src/playAudioCard.js":
/*!******************************!*\
  !*** ./src/playAudioCard.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _birds__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./birds */ "./src/birds.js");
/* harmony import */ var _getTimeFromNum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getTimeFromNum */ "./src/getTimeFromNum.js");


var playButton = document.querySelector(".card__playback-button");
var block = document.querySelector('.select');

function playAudioCard(level, cardId, isPlay, audio) {
  var currentTime = block.querySelector('.current-time');
  var thumb = block.querySelector('.timebar-circle');
  var progressBar = block.querySelector('.timebar-bar');
  var duration = block.querySelector('.duration');
  ...
  if (!isPlay) {
    ...
    playButton.classList.add("pause");
    audio.addEventListener("loadeddata", function () {
      duration.textContent = "".concat((0,_getTimeFromNum__WEBPACK_IMPORTED_MODULE_1__["default"])(audio.duration));
      audio.volume = 0.75;
    }, false);
    duration.textContent = "".concat((0,_getTimeFromNum__WEBPACK_IMPORTED_MODULE_1__["default"])(audio.duration));
  } else if (isPlay) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (playAudioCard);

/***/ }),

/***/ "./src/playAudioGallery.js":
/*!*********************************!*\
  !*** ./src/playAudioGallery.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function playAudioGallery(_x, _x2, _x3, _x4) {
  return _playAudioGallery.apply(this, arguments);
}

function _playAudioGallery() {
  _playAudioGallery = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(audioSource, audio, isPlay, blockBird) {
    var currentTime, thumb, progressBar, duration, playButton;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            currentTime = blockBird.querySelector('.current-time');
            thumb = blockBird.querySelector('.timebar-circle');
            progressBar = blockBird.querySelector('.timebar-bar');
            duration = blockBird.querySelector('.duration');
            playButton = blockBird.querySelector('.card__playback-button');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (playAudioGallery);

/***/ }),

/***/ "./src/progressAudio.js":
/*!******************************!*\
  !*** ./src/progressAudio.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _getTimeFromNum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getTimeFromNum */ "./src/getTimeFromNum.js");


function progressAudio(audio, audioBlock) {
  var progressBar = audioBlock.querySelector('.timebar-bar');
  var thumb = audioBlock.querySelector('.timebar-circle');
  var currentTime = audioBlock.querySelector('.current-time');
  var duration = audioBlock.querySelector('.duration');
  var progressAudio = audio.currentTime / audio.duration;
  progressBar.style.background = "linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) ".concat(progressAudio * 100, "%, #f0c592 2.90146%, #c93a3d 100%)");
  thumb.style.left = "".concat(progressAudio * 100) + '%';
  currentTime.textContent = (0,_getTimeFromNum__WEBPACK_IMPORTED_MODULE_0__["default"])(audio.currentTime);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (progressAudio);

/***/ }),

/***/ "./src/resetForNewGame.js":
/*!********************************!*\
  !*** ./src/resetForNewGame.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var blocLevels = document.querySelector('.categories-block');
var sectionGuess = document.querySelector('.guess');
var sectionSelect = document.querySelector('.select');
var button = document.querySelector('.play__button_next');
var wrapper = document.querySelector('.play__wrapper');
...
function resetForNewGame() {
  ...
  var resultBlock = document.querySelector('.results-block');
  resultBlock.remove();
  button.textContent = 'Next question';
  button.classList.remove('play_again');
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (resetForNewGame);
...
var wrapper = document.querySelector('.play__wrapper');
var textScore = document.querySelector('.score');
var main = document.querySelector('.play');
...
function showResults(score, lang) {
  ...
  var resultImg = document.createElement('span');

  if (lang) {
    if (score === 30) {
      resultText.textContent = "Fantastic result! You guessed it all!";
    } else {
      resultText.textContent = "Your score: ".concat(score);
    }
    ...
    if (score === 30) {
      ...
      resultText.textContent = "\u0412\u0430\u0448 \u0441\u0447\u0435\u0442: ".concat(score);
    }
...
function stopPrevAudio(buttonPlay, block, audio) {
  if (buttonPlay) {
    ...
    var progressBar = block.querySelector('.timebar-bar');
    var duration = block.querySelector('.duration');
    var playButton = block.querySelector('.card__playback-button');
    audio.pause();
    audio.currentTime = 0;
    audio.volume = 0.75;
    currentTime.textContent = '00:00';
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (stopPrevAudio);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/on_sound.png */ "./src/assets/icons/on_sound.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/off_sound.png */ "./src/assets/icons/off_sound.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/volume_white.png */ "./src/assets/icons/volume_white.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/volume_black.png */ "./src/assets/icons/volume_black.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/logo.png */ "./src/assets/icons/logo.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_5___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/house.png */ "./src/assets/icons/house.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_6___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/house_black.png */ "./src/assets/icons/house_black.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/gallery_white.png */ "./src/assets/icons/gallery_white.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/gallery_black.png */ "./src/assets/icons/gallery_black.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/ru_white.png */ "./src/assets/icons/ru_white.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/ru_black.png */ "./src/assets/icons/ru_black.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_11___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/eng_white.png */ "./src/assets/icons/eng_white.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_12___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/GitHub-Symbol.png */ "./src/assets/icons/GitHub-Symbol.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_13___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/rs_school_js.svg */ "./src/assets/icons/rs_school_js.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_14___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/img/img_guess.jpg */ "./src/assets/img/img_guess.jpg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_15___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/img/hen_result.png */ "./src/assets/img/hen_result.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_16___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/svg/cross.svg */ "./src/assets/svg/cross.svg"), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */\n/* Document\n   ========================================================================== */\n/**\n * 1. Correct the line height in all browsers.\n * 2. Prevent adjustments of font size after orientation changes in iOS.\n */\nhtml {\n  line-height: 1.15; /* 1 */\n  -webkit-text-size-adjust: 100%; /* 2 */\n}\n\n/* Sections\n   ========================================================================== */\n/**\n * Remove the margin in all browsers.\n */\nbody {\n  margin: 0;\n}\n\n/**\n * Render the `main` element consistently in IE.\n */\nmain {\n  display: block;\n}\n\n/**\n * Correct the font size and margin on `h1` elements within `section` and\n * `article` contexts in Chrome, Firefox, and Safari.\n */\nh1 {\n  font-size: 2em;\n  margin: 0.67em 0;\n}\n\n/* Grouping content\n   ========================================================================== */\n/**\n * 1. Add the correct box sizing in Firefox.\n * 2. Show the overflow in Edge and IE.\n */\nhr {\n  box-sizing: content-box; /* 1 */\n  height: 0; /* 1 */\n  overflow: visible; /* 2 */\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\npre {\n  font-family: monospace, monospace; /* 1 */\n  font-size: 1em; /* 2 */\n}\n\n/* Text-level semantics\n   ========================================================================== */\n/**\n * Remove the gray background on active links in IE 10.\n */\na {\n  background-color: transparent;\n}\n\n/**\n * 1. Remove the bottom border in Chrome 57-\n * 2. Add the correct text decoration in Chrome, Edge, IE, Opera, and Safari.\n */\nabbr[title] {\n  border-bottom: none; /* 1 */\n  text-decoration: underline; /* 2 */\n  text-decoration: underline dotted; /* 2 */\n}\n\n/**\n * Add the correct font weight in Chrome, Edge, and Safari.\n */\nb,\nstrong {\n  font-weight: bolder;\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\ncode,\nkbd,\nsamp {\n  font-family: monospace, monospace; /* 1 */\n  font-size: 1em; /* 2 */\n}\n\n/**\n * Add the correct font size in all browsers.\n */\nsmall {\n  font-size: 80%;\n}\n\n/**\n * Prevent `sub` and `sup` elements from affecting the line height in\n * all browsers.\n */\nsub,\nsup {\n  font-size: 75%;\n  line-height: 0;\n  position: relative;\n  vertical-align: baseline;\n}\n\nsub {\n  bottom: -0.25em;\n}\n\nsup {\n  top: -0.5em;\n}\n\n/* Embedded content\n   ========================================================================== */\n/**\n * Remove the border on images inside links in IE 10.\n */\nimg {\n  border-style: none;\n}\n\n/* Forms\n   ========================================================================== */\n/**\n * 1. Change the font styles in all browsers.\n * 2. Remove the margin in Firefox and Safari.\n */\nbutton,\ninput,\noptgroup,\nselect,\ntextarea {\n  font-family: inherit; /* 1 */\n  font-size: 100%; /* 1 */\n  line-height: 1.15; /* 1 */\n  margin: 0; /* 2 */\n}\n\n/**\n * Show the overflow in IE.\n * 1. Show the overflow in Edge.\n */\nbutton,\ninput { /* 1 */\n  overflow: visible;\n}\n\n/**\n * Remove the inheritance of text transform in Edge, Firefox, and IE.\n * 1. Remove the inheritance of text transform in Firefox.\n */\nbutton,\nselect { /* 1 */\n  text-transform: none;\n}\n\n/**\n * Correct the inability to style clickable types in iOS and Safari.\n */\nbutton,\n[type=button],\n[type=reset],\n[type=submit] {\n  -webkit-appearance: button;\n}\n\n/**\n * Remove the inner border and padding in Firefox.\n */\nbutton::-moz-focus-inner,\n[type=button]::-moz-focus-inner,\n[type=reset]::-moz-focus-inner,\n[type=submit]::-moz-focus-inner {\n  border-style: none;\n  padding: 0;\n}\n\n/**\n * Restore the focus styles unset by the previous rule.\n */\nbutton:-moz-focusring,\n[type=button]:-moz-focusring,\n[type=reset]:-moz-focusring,\n[type=submit]:-moz-focusring {\n  outline: 1px dotted ButtonText;\n}\n\n/**\n * Correct the padding in Firefox.\n */\nfieldset {\n  padding: 0.35em 0.75em 0.625em;\n}\n\n/**\n * 1. Correct the text wrapping in Edge and IE.\n * 2. Correct the color inheritance from `fieldset` elements in IE.\n * 3. Remove the padding so developers are not caught out when they zero out\n *    `fieldset` elements in all browsers.\n */\nlegend {\n  box-sizing: border-box; /* 1 */\n  color: inherit; /* 2 */\n  display: table; /* 1 */\n  max-width: 100%; /* 1 */\n  padding: 0; /* 3 */\n  white-space: normal; /* 1 */\n}\n\n/**\n * Add the correct vertical alignment in Chrome, Firefox, and Opera.\n */\nprogress {\n  vertical-align: baseline;\n}\n\n/**\n * Remove the default vertical scrollbar in IE 10+.\n */\ntextarea {\n  overflow: auto;\n}\n\n/**\n * 1. Add the correct box sizing in IE 10.\n * 2. Remove the padding in IE 10.\n */\n[type=checkbox],\n[type=radio] {\n  box-sizing: border-box; /* 1 */\n  padding: 0; /* 2 */\n}\n\n/**\n * Correct the cursor style of increment and decrement buttons in Chrome.\n */\n[type=number]::-webkit-inner-spin-button,\n[type=number]::-webkit-outer-spin-button {\n  height: auto;\n}\n\n/**\n * 1. Correct the odd appearance in Chrome and Safari.\n * 2. Correct the outline style in Safari.\n */\n[type=search] {\n  -webkit-appearance: textfield; /* 1 */\n  outline-offset: -2px; /* 2 */\n}\n\n/**\n * Remove the inner padding in Chrome and Safari on macOS.\n */\n[type=search]::-webkit-search-decoration {\n  -webkit-appearance: none;\n}\n\n/**\n * 1. Correct the inability to style clickable types in iOS and Safari.\n * 2. Change font properties to `inherit` in Safari.\n */\n::-webkit-file-upload-button {\n  -webkit-appearance: button; /* 1 */\n  font: inherit; /* 2 */\n}\n\n/* Interactive\n   ========================================================================== */\n/*\n * Add the correct display in Edge, IE 10+, and Firefox.\n */\ndetails {\n  display: block;\n}\n\n/*\n * Add the correct display in all browsers.\n */\nsummary {\n  display: list-item;\n}\n\n/* Misc\n   ========================================================================== */\n/**\n * Add the correct display in IE 10+.\n */\ntemplate {\n  display: none;\n}\n\n/**\n * Add the correct display in IE 10.\n */\n[hidden] {\n  display: none;\n}\n\nsection, main, footer, header, article {\n  display: block;\n}\n\n* {\n  box-sizing: border-box;\n}\n\nhtml {\n  font-size: 10px;\n}\n\nbody {\n  font-size: 1.6rem;\n  font-family: \"Roboto\", Verdana, Geneva, Tahoma, sans-serif;\n  scroll-behavior: smooth;\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  background-color: #f0c592;\n}\n\n.main {\n  position: relative;\n}\n\n.body__wrapper {\n  margin: 0 auto;\n  width: 70%;\n}\n@media screen and (max-width: 1200px) {\n  .body__wrapper {\n    width: 90%;\n  }\n}\n\n.button_nav {\n  font-size: 50px;\n  font-weight: 400;\n  font-style: normal;\n  line-height: 120%;\n}\n\n.text_btn {\n  font-size: 16px;\n  font-weight: 500;\n  font-style: normal;\n  line-height: 140%;\n}\n\n.text_smallParagraph {\n  font-size: 15px;\n  font-weight: 300;\n  font-style: normal;\n  line-height: 120%;\n}\n\n.feed__mainText {\n  font-size: 16px;\n  font-weight: 400;\n  font-style: normal;\n  line-height: 130%;\n}\n\n.feed__commentText {\n  font-size: 16px;\n  font-weight: 500;\n  font-style: normal;\n  line-height: 130%;\n}\n\n.text__donate {\n  font-size: 16.3px;\n  font-weight: 400;\n  font-style: normal;\n  line-height: 140%;\n}\n\nh4 {\n  font-size: 20px;\n  font-weight: 700;\n  font-style: normal;\n  line-height: 140%;\n}\n\n.hidden {\n  display: none;\n}\n\n.button__nav {\n  color: #F1F3F2;\n  font-size: 48px;\n  line-height: 140%;\n  text-align: center;\n  text-transform: uppercase;\n  background: #c93a3d;\n  border-radius: 5px;\n  border-style: none;\n  font-family: \"Roboto\", Verdana, Geneva, Tahoma, sans-serif;\n  transition: all 0.3s;\n  cursor: pointer;\n}\n.button__nav:hover {\n  background-color: #1e797f;\n}\n.button__nav:active {\n  background: #f0c592;\n}\n\n.start__button_sound {\n  position: absolute;\n  top: 10%;\n  right: 10%;\n  background-color: #c93a3d;\n  border-radius: 50%;\n  border-style: none;\n  box-shadow: 5px #333B41;\n  padding: 0;\n}\n@media screen and (min-width: 768px) {\n  .start__button_sound {\n    width: 100px;\n    height: 100px;\n  }\n}\n@media screen and (max-width: 768px) {\n  .start__button_sound {\n    width: 50px;\n    height: 50px;\n  }\n}\n@media screen and (max-width: 500px) {\n  .start__button_sound {\n    width: 30px;\n    height: 30px;\n  }\n}\n.start__button_sound:hover {\n  background-color: #1e797f;\n}\n.start__button_sound .button__img_sound {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n}\n@media screen and (min-width: 768px) {\n  .start__button_sound .button__img_sound {\n    width: 100px;\n    height: 100px;\n  }\n}\n@media screen and (max-width: 768px) {\n  .start__button_sound .button__img_sound {\n    width: 50px;\n    height: 50px;\n  }\n}\n@media screen and (max-width: 500px) {\n  .start__button_sound .button__img_sound {\n    width: 30px;\n    height: 30px;\n  }\n}\n\n.sound_off .button__img_sound {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n}\n@media screen and (min-width: 768px) {\n  .sound_off .button__img_sound {\n    width: 100px;\n    height: 100px;\n  }\n}\n@media screen and (max-width: 768px) {\n  .sound_off .button__img_sound {\n    width: 50px;\n    height: 50px;\n  }\n}\n@media screen and (max-width: 500px) {\n  .sound_off .button__img_sound {\n    width: 30px;\n    height: 30px;\n  }\n}\n\n.button__img_volume {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");\n  background-color: #1e797f;\n  border-radius: 50%;\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n  margin-left: 5px;\n  width: 30px;\n  height: 30px;\n  cursor: pointer;\n}\n.button__img_volume:hover {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ");\n}\n\n.play__button_next {\n  width: 100%;\n  border-radius: 5px;\n  border-style: none;\n  padding: 2rem;\n  font-weight: 700;\n  background-color: rgba(30, 121, 127, 0.2);\n  color: rgba(30, 121, 127, 0.8);\n  margin-bottom: 3%;\n  cursor: pointer;\n}\n\n.play_again {\n  width: 60%;\n  color: #F1F3F2;\n  background-color: #c93a3d;\n  height: 20%;\n  font-size: 3.6rem;\n  font-weight: 500;\n}\n.play_again:hover {\n  scale: 1.05;\n}\n@media screen and (max-width: 1700px) {\n  .play_again {\n    width: 80%;\n  }\n}\n@media screen and (max-width: 500px) {\n  .play_again {\n    width: 100%;\n    font-size: 1.8rem;\n  }\n}\n\n.active {\n  background: #1e797f;\n  color: #F1F3F2;\n}\n\n.press {\n  background-color: #1e797f;\n}\n\n.header__nav {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0;\n  margin: 0;\n}\n.header__nav .nav__list {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0;\n  margin: 0;\n  gap: 2%;\n}\n.header__nav .nav__list .nav__item {\n  list-style: none;\n}\n.header__nav .nav__list .item_button {\n  margin-left: -10%;\n  margin-right: 10%;\n}\n@media screen and (max-width: 768px) {\n  .header__nav .nav__list .item_button {\n    margin-left: 0%;\n    margin-right: 3%;\n  }\n}\n\n.img_logo {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ");\n  background-size: contain;\n  background-repeat: no-repeat;\n  width: 70px;\n  height: 70px;\n}\n@media screen and (min-width: 768px) {\n  .img_logo {\n    width: 100px;\n    height: 100px;\n  }\n}\n\n.audio-player {\n  width: 100%;\n  min-width: 100px;\n}\n.audio-player .controls {\n  display: flex;\n  align-items: center;\n}\n.audio-player .playback-button {\n  display: flex;\n  align-items: center;\n  transition: 0.2s;\n  width: 40px;\n  height: 40px;\n  border: 2px solid #c93a3d;\n  justify-content: center;\n  border-radius: 50%;\n  margin-right: 20px;\n  margin-bottom: 12px;\n  cursor: pointer;\n}\n.audio-player .playback-button .button__img_sound {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n  width: 30px;\n  height: 30px;\n}\n.audio-player .playback-button .img-play {\n  transition: 0.2s;\n  width: 18px;\n  height: 18px;\n  align-self: center;\n}\n.audio-player .pause .button__img_sound {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n  width: 30px;\n  height: 30px;\n}\n\n.timebar {\n  flex-grow: 1;\n  flex-shrink: 1;\n  flex-basis: 0%;\n  position: relative;\n}\n\n.timebar-bar {\n  height: 6px;\n  min-width: 100%;\n  background: linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) 0%, #f0c592 2.90146%, #c93a3d 100%);\n}\n\n.timebar-circle {\n  background-color: #1e797f;\n  width: 16px;\n  height: 16px;\n  border-radius: 50%;\n  position: absolute;\n  top: 0;\n  -webkit-transform: translate(-50%, calc(-50% + 2px));\n  transform: translate(-50%, calc(-50% + 2px));\n  box-shadow: 0 0 4px 0 rgba(0, 0, 0, 0.2);\n  cursor: pointer;\n}\n\n.timebar-time-info {\n  margin-top: 8px;\n  font-size: 11px;\n  color: #d3d3d3;\n  display: flex;\n  justify-content: space-between;\n}\n\n.volume-block {\n  display: flex;\n  align-items: center;\n  position: relative;\n}\n.volume-block .bar_volume {\n  display: none;\n  min-width: 10%;\n  background: linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) 75%, #f0c592 2.90146%, #c93a3d 100%);\n}\n.volume-block .active {\n  display: block;\n}\n\nheader {\n  width: 100%;\n  margin: 0 auto;\n  background-color: #f0c592;\n}\n\n.header__wrapper {\n  height: 10%;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 2%;\n}\n\n.header__wrapper_play {\n  display: flex;\n  flex-direction: column;\n  padding-top: 2%;\n  padding-bottom: 0;\n}\n.header__wrapper_play .logo-block {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.header__wrapper_play .score {\n  text-align: center;\n  font-size: 32px;\n  font-weight: 200;\n  color: #F1F3F2;\n  margin: 0;\n}\n.header__wrapper_play .categories-block {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  flex-wrap: wrap;\n  list-style: none;\n  font-size: 20px;\n  padding: 0;\n  margin-bottom: 0;\n  background-color: #1e797f;\n  border-radius: 5px;\n  gap: 10px;\n}\n.header__wrapper_play .categories-block .category {\n  padding: 1rem;\n  font-weight: 500;\n}\n.header__wrapper_play .categories-block .category_selected {\n  color: #c93a3d;\n}\n\n.img_house {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_5___ + ");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n  background-position: right;\n}\n@media screen and (min-width: 768px) {\n  .img_house {\n    width: 69.2px;\n    height: 69.2px;\n  }\n}\n@media screen and (max-width: 768px) {\n  .img_house {\n    width: 50px;\n    height: 50px;\n  }\n}\n.img_house:hover {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_6___ + ");\n}\n\n.img_gallery {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_7___ + ");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: contain;\n  background-position: right;\n}\n@media screen and (min-width: 768px) {\n  .img_gallery {\n    width: 69.2px;\n    height: 69.2px;\n  }\n}\n@media screen and (max-width: 768px) {\n  .img_gallery {\n    width: 50px;\n    height: 50px;\n  }\n}\n.img_gallery:hover {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_8___ + ");\n}\n\n.img_lang {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_9___ + ");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n  background-position: right;\n  background-size: contain;\n}\n@media screen and (min-width: 768px) {\n  .img_lang {\n    width: 40px;\n    height: 40px;\n  }\n}\n@media screen and (max-width: 768px) {\n  .img_lang {\n    width: 30px;\n    height: 30px;\n  }\n}\n.img_lang:hover {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_10___ + ");\n}\n\n.en {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_11___ + ");\n}\n.en:hover {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_11___ + ");\n}\n\n.main__start {\n  position: relative;\n}\n.main__start .start-img {\n  width: 100%;\n  height: 80%;\n  border-radius: 5px;\n  border: 3px solid #1e797f;\n}\n@media screen and (max-width: 500px) {\n  .main__start .start-img {\n    width: 100%;\n    display: none;\n  }\n}\n@media screen and (min-width: 500px) {\n  .main__start .start-img_mobile {\n    display: none;\n  }\n}\n@media screen and (max-width: 500px) {\n  .main__start .start-img_mobile {\n    width: 100%;\n    border-radius: 5px;\n    border: 3px solid #1e797f;\n  }\n}\n\n.main__wrapper {\n  display: flex;\n  flex-direction: column;\n}\n\n.footer {\n  background-color: #f0c592;\n  height: 20%;\n}\n.footer .footer__wrapper {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 1%;\n  color: #F1F3F2;\n  font-size: 30px;\n  color: #F1F3F2;\n}\n@media screen and (max-width: 569px) {\n  .footer .footer__wrapper {\n    font-size: 16px;\n  }\n}\n.footer .footer__wrapper .img-github {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_12___ + ");\n  width: 140px;\n  height: 70px;\n  background-repeat: no-repeat;\n  background-size: contain;\n}\n@media screen and (max-width: 569px) {\n  .footer .footer__wrapper .img-github {\n    width: 70px;\n    height: 35px;\n  }\n}\n.footer .footer__wrapper .rssschool {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_13___ + ");\n  width: 140px;\n  height: 40px;\n  background-repeat: no-repeat;\n  background-size: contain;\n  margin-left: 2%;\n}\n@media screen and (max-width: 569px) {\n  .footer .footer__wrapper .rssschool {\n    width: 70px;\n    height: 16px;\n  }\n}\n\n.guess__wrapper {\n  display: flex;\n  flex-wrap: wrap;\n  background-color: rgba(30, 121, 127, 0.2);\n  padding: 2%;\n  margin-bottom: 2%;\n  margin-top: 0;\n  border-radius: 5px;\n  gap: 3%;\n}\n@media screen and (max-width: 569px) {\n  .guess__wrapper {\n    flex-direction: column;\n  }\n}\n.guess__wrapper .img-guess {\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_14___ + ");\n  background-repeat: no-repeat;\n  background-size: cover;\n  width: 200px;\n  height: 155px;\n  border-radius: 5px;\n}\n@media screen and (max-width: 569px) {\n  .guess__wrapper .img-guess {\n    align-self: center;\n    margin-bottom: 3%;\n  }\n}\n.guess__wrapper .block-guess {\n  display: flex;\n  flex-direction: column;\n  flex-wrap: wrap;\n  width: calc(100% - 240px);\n  flex-shrink: 0;\n}\n@media screen and (max-width: 569px) {\n  .guess__wrapper .block-guess {\n    width: 100%;\n  }\n}\n.guess__wrapper .block-guess .name-guess {\n  margin-top: 0;\n}\n@media screen and (max-width: 569px) {\n  .guess__wrapper .block-guess .name-guess {\n    text-align: center;\n  }\n}\n\n.results__wrapper {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.results-block {\n  background-color: rgba(30, 121, 127, 0.2);\n  width: 60%;\n  height: 40%;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin: 0 auto;\n  border-radius: 5px;\n  margin-bottom: 3%;\n}\n@media screen and (max-width: 1700px) {\n  .results-block {\n    width: 80%;\n  }\n}\n@media screen and (max-width: 500px) {\n  .results-block {\n    width: 100%;\n  }\n}\n.results-block .text-results {\n  text-align: center;\n  font-weight: 700;\n  font-size: 3.2rem;\n  color: #1e797f;\n  background-color: rgba(241, 243, 242, 0.5);\n  width: 40%;\n  border-radius: 5px;\n}\n@media screen and (min-width: 1000px) {\n  .results-block .text-results {\n    font-size: 4.8rem;\n  }\n}\n@media screen and (max-width: 700px) {\n  .results-block .text-results {\n    width: 50%;\n    font-size: 2.4rem;\n  }\n}\n@media screen and (max-width: 500px) {\n  .results-block .text-results {\n    width: 70%;\n  }\n}\n.results-block .img-results {\n  display: inline-block;\n  width: 320px;\n  height: 280px;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_15___ + ");\n  background-size: cover;\n  background-repeat: no-repeat;\n}\n@media screen and (min-width: 500px) and (max-width: 700px) {\n  .results-block .img-results {\n    width: 220px;\n    height: 200px;\n  }\n}\n@media screen and (max-width: 500px) {\n  .results-block .img-results {\n    width: 120px;\n    height: 100px;\n  }\n}\n\n.message__wrapper {\n  position: absolute;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 2;\n  background-color: rgba(51, 59, 65, 0.5);\n}\n.message__wrapper .message_block {\n  margin: 0 auto;\n  width: 80%;\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background-color: #131212;\n  padding: 20px 10px;\n}\n.message__wrapper .message_block h1 {\n  margin: 0;\n  color: #333B41;\n  margin-bottom: 10px;\n}\n.message__wrapper .message_block .cross {\n  position: absolute;\n  top: 2%;\n  right: 2%;\n  display: inline-block;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_16___ + ");\n  width: 15px;\n  height: 15px;\n  background-size: cover;\n}\n\n.select {\n  display: flex;\n  gap: 2%;\n  font-weight: 500;\n  flex-wrap: wrap;\n  margin-bottom: 3%;\n}\n@media screen and (max-width: 569px) {\n  .select {\n    flex-direction: column;\n  }\n}\n.select .answer-wrapper {\n  width: 33%;\n  height: 100%;\n}\n@media screen and (max-width: 569px) {\n  .select .answer-wrapper {\n    width: 100%;\n    margin-bottom: 2%;\n  }\n}\n.select .answer-wrapper .answer-list {\n  display: flex;\n  flex-direction: column;\n  list-style: none;\n  padding: 0;\n  margin: 0;\n  background-color: rgba(30, 121, 127, 0.2);\n  border-radius: 5px;\n}\n.select .answer-wrapper .answer-list .answer-item {\n  border: 1px solid #f0c592;\n  padding: 1rem 3rem;\n  cursor: pointer;\n}\n.select .answer-wrapper .answer-list .answer-item:hover {\n  color: #F1F3F2;\n}\n.select .answer-wrapper .answer-list .answer-item .answer-indicator {\n  display: inline-block;\n  margin-right: 1rem;\n  width: 10px;\n  height: 10px;\n  border-radius: 50%;\n  border: 1px solid #333B41;\n}\n.select .card-wrapper {\n  display: flex;\n  background-color: rgba(30, 121, 127, 0.2);\n  border-radius: 5px;\n  flex-grow: 1;\n  flex-shrink: 0;\n  flex-wrap: wrap;\n  padding: 2%;\n  width: 33%;\n}\n@media screen and (max-width: 569px) {\n  .select .card-wrapper {\n    width: 100%;\n  }\n}\n.select .card-wrapper .instructions {\n  display: flex;\n  flex-direction: column;\n  margin: 0;\n}\n.select .card-wrapper .card-body {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 2%;\n}\n.select .card-wrapper .card-body .img-bird {\n  width: 200px;\n  height: 155px;\n  border-radius: 5px;\n  align-self: center;\n}\n.select .card-wrapper .card-body .card-list {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n  flex-grow: 1;\n  flex-shrink: 1;\n}\n.select .card-wrapper .hidden {\n  display: none;\n}\n\n.bird-name {\n  margin: 0;\n}\n\n.bird-description {\n  max-width: 100%;\n}\n\n.card-wrapper {\n  display: flex;\n  background-color: rgba(30, 121, 127, 0.2);\n  border-radius: 5px;\n  flex-grow: 1;\n  flex-shrink: 0;\n  flex-wrap: wrap;\n  padding: 2%;\n  margin-bottom: 3%;\n}\n@media screen and (max-width: 569px) {\n  .card-wrapper {\n    width: 100%;\n  }\n}\n.card-wrapper .card-body {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 2%;\n}\n.card-wrapper .card-body .img-bird {\n  width: 200px;\n  height: 155px;\n  border-radius: 5px;\n  align-self: center;\n}\n.card-wrapper .card-body .card-list {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n  flex-grow: 1;\n  flex-shrink: 1;\n}", "",{"version":3,"sources":["webpack://./src/styles/base/_normalize.scss","webpack://./src/styles/main.scss","webpack://./src/styles/base/_base.scss","webpack://./src/styles/abstracts/_variables.scss","webpack://./src/styles/abstracts/_mixins.scss","webpack://./src/styles/components/_button.scss","webpack://./src/styles/components/_navigation.scss","webpack://./src/styles/components/_logo.scss","webpack://./src/styles/components/_audio.scss","webpack://./src/styles/layout/_header.scss","webpack://./src/styles/layout/_start.scss","webpack://./src/styles/layout/_footer.scss","webpack://./src/styles/layout/_guess.scss","webpack://./src/styles/layout/_results.scss","webpack://./src/styles/layout/_message.scss","webpack://./src/styles/layout/_select.scss","webpack://./src/styles/layout/_gallery.scss"],"names":[],"mappings":"AAAA,2EAAA;AAEA;+EAAA;AAGA;;;EAAA;AAKC;EACG,iBAAA,EAAA,MAAA;EACA,8BAAA,EAAA,MAAA;ACDJ;;ADIE;+EAAA;AAGA;;EAAA;AAIA;EACE,SAAA;ACHJ;;ADME;;EAAA;AAIA;EACE,cAAA;ACJJ;;ADOE;;;EAAA;AAKA;EACE,cAAA;EACA,gBAAA;ACLJ;;ADQE;+EAAA;AAGA;;;EAAA;AAKA;EACE,uBAAA,EAAA,MAAA;EACA,SAAA,EAAA,MAAA;EACA,iBAAA,EAAA,MAAA;ACPJ;;ADUE;;;EAAA;AAKA;EACE,iCAAA,EAAA,MAAA;EACA,cAAA,EAAA,MAAA;ACRJ;;ADWE;+EAAA;AAGA;;EAAA;AAIA;EACE,6BAAA;ACVJ;;ADaE;;;EAAA;AAKA;EACE,mBAAA,EAAA,MAAA;EACA,0BAAA,EAAA,MAAA;EACA,iCAAA,EAAA,MAAA;ACXJ;;ADcE;;EAAA;AAIA;;EAEE,mBAAA;ACZJ;;ADeE;;;EAAA;AAKA;;;EAGE,iCAAA,EAAA,MAAA;EACA,cAAA,EAAA,MAAA;ACbJ;;ADgBE;;EAAA;AAIA;EACE,cAAA;ACdJ;;ADiBE;;;EAAA;AAKA;;EAEE,cAAA;EACA,cAAA;EACA,kBAAA;EACA,wBAAA;ACfJ;;ADkBE;EACE,eAAA;ACfJ;;ADkBE;EACE,WAAA;ACfJ;;ADkBE;+EAAA;AAGA;;EAAA;AAIA;EACE,kBAAA;ACjBJ;;ADoBE;+EAAA;AAGA;;;EAAA;AAKA;;;;;EAKE,oBAAA,EAAA,MAAA;EACA,eAAA,EAAA,MAAA;EACA,iBAAA,EAAA,MAAA;EACA,SAAA,EAAA,MAAA;ACnBJ;;ADsBE;;;EAAA;AAKA;QACQ,MAAA;EACN,iBAAA;ACpBJ;;ADuBE;;;EAAA;AAKA;SACS,MAAA;EACP,oBAAA;ACrBJ;;ADwBE;;EAAA;AAIA;;;;EAIE,0BAAA;ACtBJ;;ADyBE;;EAAA;AAIA;;;;EAIE,kBAAA;EACA,UAAA;ACvBJ;;AD0BE;;EAAA;AAIA;;;;EAIE,8BAAA;ACxBJ;;AD2BE;;EAAA;AAIA;EACE,8BAAA;ACzBJ;;AD4BE;;;;;EAAA;AAOA;EACE,sBAAA,EAAA,MAAA;EACA,cAAA,EAAA,MAAA;EACA,cAAA,EAAA,MAAA;EACA,eAAA,EAAA,MAAA;EACA,UAAA,EAAA,MAAA;EACA,mBAAA,EAAA,MAAA;AC1BJ;;AD6BE;;EAAA;AAIA;EACE,wBAAA;AC3BJ;;AD8BE;;EAAA;AAIA;EACE,cAAA;AC5BJ;;AD+BE;;;EAAA;AAKA;;EAEE,sBAAA,EAAA,MAAA;EACA,UAAA,EAAA,MAAA;AC7BJ;;ADgCE;;EAAA;AAIA;;EAEE,YAAA;AC9BJ;;ADiCE;;;EAAA;AAKA;EACE,6BAAA,EAAA,MAAA;EACA,oBAAA,EAAA,MAAA;AC/BJ;;ADkCE;;EAAA;AAIA;EACE,wBAAA;AChCJ;;ADmCE;;;EAAA;AAKA;EACE,0BAAA,EAAA,MAAA;EACA,aAAA,EAAA,MAAA;ACjCJ;;ADoCE;+EAAA;AAGA;;EAAA;AAIA;EACE,cAAA;ACnCJ;;ADsCE;;EAAA;AAIA;EACE,kBAAA;ACpCJ;;ADuCE;+EAAA;AAGA;;EAAA;AAIA;EACE,aAAA;ACtCJ;;ADyCE;;EAAA;AAIA;EACE,aAAA;ACvCJ;;AD0CE;EACE,cAAA;ACvCJ;;ADyCE;EACE,sBAAA;ACtCJ;;AC3TA;EACI,eAAA;AD8TJ;;AC3TA;EACI,iBAAA;EACA,0DAAA;EACA,uBAAA;EACA,cAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,yBCbW;AF2Uf;;AC3TA;EACI,kBAAA;AD8TJ;;AC3TA;EACI,cAAA;EACA,UAAA;AD8TJ;AC5TI;EAJJ;IAKQ,UAAA;ED+TN;AACF;;ACzTA;EE/BG,eFgCe;EE/Bf,gBF+B2B;EE9B3B,kBAHyC;EAIzC,iBF6BqB;AD+TxB;;AC3TA;EEpCG,eFqCe;EEpCf,gBFoC2B;EEnC3B,kBAHyC;EAIzC,iBFkCqB;ADiUxB;;AC7TA;EEzCG,eF0Ce;EEzCf,gBFyC2B;EExC3B,kBAHyC;EAIzC,iBFuCqB;ADmUxB;;AC/TA;EE9CG,eF+Ce;EE9Cf,gBF8C2B;EE7C3B,kBAHyC;EAIzC,iBF4CqB;ADqUxB;;AClUA;EElDG,eFmDe;EElDf,gBFkD2B;EEjD3B,kBAHyC;EAIzC,iBFgDqB;ADwUxB;;ACpUA;EEvDG,iBFwDe;EEvDf,gBFuD6B;EEtD7B,kBAHyC;EAIzC,iBFqDuB;AD0U1B;;ACvUA;EE3DG,eF4De;EE3Df,gBF2D2B;EE1D3B,kBAHyC;EAIzC,iBFyDqB;AD6UxB;;AC1UA;EACI,aAAA;AD6UJ;;AI9YA;EACI,cFOc;EENd,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,yBAAA;EACA,mBFJW;EEKX,kBAAA;EACA,kBAAA;EACA,0DAAA;EACA,oBAAA;EACA,eAAA;AJiZJ;AI9YI;EACI,yBFZY;AF4ZpB;AI9YI;EACI,mBFba;AF6ZrB;;AI5YA;EACI,kBAAA;EACA,QAAA;EACA,UAAA;EACA,yBFxBW;EEyBX,kBAAA;EACA,kBAAA;EACA,uBAAA;EACA,UAAA;AJ+YJ;AI7YI;EAVJ;IAWQ,YAAA;IACA,aAAA;EJgZN;AACF;AI9YI;EAfJ;IAgBQ,WAAA;IACA,YAAA;EJiZN;AACF;AI/YI;EApBJ;IAqBQ,WAAA;IACA,YAAA;EJkZN;AACF;AIhZI;EACI,yBF7CY;AF+bpB;AIhZI;EACI,qBAAA;EACA,yDAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;AJkZR;AIhZQ;EAPJ;IAQQ,YAAA;IACA,aAAA;EJmZV;AACF;AIjZQ;EAZJ;IAaQ,WAAA;IACA,YAAA;EJoZV;AACF;AIlZQ;EAjBJ;IAkBQ,WAAA;IACA,YAAA;EJqZV;AACF;;AI/YI;EACI,qBAAA;EACA,yDAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;AJkZR;AIhZQ;EAPJ;IAQQ,YAAA;IACA,aAAA;EJmZV;AACF;AIjZQ;EAZJ;IAaQ,WAAA;IACA,YAAA;EJoZV;AACF;AIlZQ;EAjBJ;IAkBQ,WAAA;IACA,YAAA;EJqZV;AACF;;AIhZA;EACI,qBAAA;EACA,yDAAA;EACA,yBFpGc;EEqGd,kBAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;EACA,gBAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;AJmZJ;AIhZI;EACI,yDAAA;AJkZR;;AI7YA;EACI,WAAA;EACA,kBAAA;EACA,kBAAA;EACA,aAAA;EACA,gBAAA;EACA,yCAAA;EACA,8BAAA;EACA,iBAAA;EACA,eAAA;AJgZJ;;AI7YA;EACI,UAAA;EACA,cF/Hc;EEgId,yBFtIW;EEuIX,WAAA;EACA,iBAAA;EACA,gBAAA;AJgZJ;AI9YI;EACI,WAAA;AJgZR;AI7YI;EAZJ;IAaQ,UAAA;EJgZN;AACF;AI9YI;EAhBJ;IAiBQ,WAAA;IACA,iBAAA;EJiZN;AACF;;AI5YA;EACI,mBF3JgB;EE4JhB,cFvJc;AFsiBlB;;AI5YA;EACI,yBFhKgB;AF+iBpB;;AKljBA;EACE,aAAA;EACA,mBAAA;EACA,mBAAA;EACA,8BAAA;EACA,UAAA;EACA,SAAA;ALqjBF;AKnjBE;EACE,aAAA;EACA,mBAAA;EACA,mBAAA;EACA,8BAAA;EACA,UAAA;EACA,SAAA;EACA,OAAA;ALqjBJ;AKnjBI;EACE,gBAAA;ALqjBN;AKljBI;EACE,iBAAA;EACA,iBAAA;ALojBN;AKljBM;EAJF;IAKI,eAAA;IACA,gBAAA;ELqjBN;AACF;;AMjlBA;EACI,qBAAA;EACA,yDAAA;EACA,wBAAA;EACA,4BAAA;EACA,WAAA;EACA,YAAA;ANolBJ;AMllBI;EARJ;IASQ,YAAA;IACA,aAAA;ENqlBN;AACF;;AOhmBA;EACI,WAAA;EACA,gBAAA;APmmBJ;AOjmBI;EACI,aAAA;EACA,mBAAA;APmmBR;AO/lBI;EACE,aAAA;EACA,mBAAA;EACA,gBAAA;EACA,WAAA;EACA,YAAA;EACA,yBAAA;EACA,uBAAA;EACA,kBAAA;EACA,kBAAA;EACA,mBAAA;EACA,eAAA;APimBN;AO/lBM;EACE,qBAAA;EACA,yDAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;EACA,WAAA;EACA,YAAA;APimBR;AO9lBM;EACE,gBAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;APgmBR;AOzlBM;EACE,qBAAA;EACA,yDAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;EACA,WAAA;EACA,YAAA;AP2lBR;;AOrlBA;EACE,YAAA;EACA,cAAA;EACA,cAAA;EACA,kBAAA;APwlBF;;AOplBA;EACI,WAAA;EACA,eAAA;EACA,uGAAA;APulBJ;;AOplBA;EACE,yBAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,MAAA;EACA,oDAAA;EACA,4CAAA;EACA,wCAAA;EACA,eAAA;APulBF;;AOnlBA;EACI,eAAA;EACA,eAAA;EACA,cAAA;EACA,aAAA;EACA,8BAAA;APslBJ;;AOllBA;EACE,aAAA;EACA,mBAAA;EACA,kBAAA;APqlBF;AOnlBE;EACE,aAAA;EACA,cAAA;EACA,wGAAA;APqlBJ;AOllBE;EACE,cAAA;APolBJ;;AQ9rBA;EACE,WAAA;EACA,cAAA;EACA,yBNHa;AFosBf;;AQ9rBA;EACE,WAAA;EACA,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,WAAA;ARisBF;;AQ9rBA;EACE,aAAA;EACA,sBAAA;EACA,eAAA;EACA,iBAAA;ARisBF;AQ/rBE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;ARisBJ;AQ9rBE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,cNtBc;EMuBd,SAAA;ARgsBJ;AQ7rBE;EACE,aAAA;EACA,mBAAA;EACA,6BAAA;EACA,eAAA;EACA,gBAAA;EACA,eAAA;EACA,UAAA;EACA,gBAAA;EACA,yBNvCc;EMwCd,kBAAA;EACA,SAAA;AR+rBJ;AQ7rBI;EACE,aAAA;EACA,gBAAA;AR+rBN;AQ5rBI;EACE,cNnDS;AFivBf;;AQrrBA;EACE,qBAAA;EACA,yDAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;EACA,0BAAA;ARwrBF;AQtrBE;EARF;IASM,aAAA;IACA,cAAA;ERyrBJ;AACF;AQvrBE;EAbF;IAcM,WAAA;IACA,YAAA;ER0rBJ;AACF;AQxrBE;EACE,yDAAA;AR0rBJ;;AQrrBA;EACE,qBAAA;EACA,yDAAA;EACA,4BAAA;EACA,2BAAA;EACA,wBAAA;EACA,0BAAA;ARwrBF;AQrrBE;EATF;IAUM,aAAA;IACA,cAAA;ERwrBJ;AACF;AQtrBE;EAdF;IAeM,WAAA;IACA,YAAA;ERyrBJ;AACF;AQvrBE;EACE,yDAAA;ARyrBJ;;AQprBA;EAEE,qBAAA;EACA,yDAAA;EACA,4BAAA;EACA,2BAAA;EACA,sBAAA;EACA,0BAAA;EACA,wBAAA;ARsrBF;AQprBE;EAVF;IAWM,WAAA;IACA,YAAA;ERurBJ;AACF;AQrrBE;EAfF;IAgBM,WAAA;IACA,YAAA;ERwrBJ;AACF;AQtrBE;EACE,0DAAA;ARwrBJ;;AQnrBA;EACE,0DAAA;ARsrBF;AQprBE;EACE,0DAAA;ARsrBJ;;ASn0BA;EACI,kBAAA;ATs0BJ;ASr0BI;EACI,WAAA;EACA,WAAA;EACA,kBAAA;EACA,yBAAA;ATu0BR;ASr0BQ;EANJ;IAOQ,WAAA;IACA,aAAA;ETw0BV;AACF;ASn0BQ;EADJ;IAEQ,aAAA;ETs0BV;AACF;ASp0BQ;EALJ;IAMM,WAAA;IACA,kBAAA;IACA,yBAAA;ETu0BR;AACF;;ASl0BA;EACI,aAAA;EACA,sBAAA;ATq0BJ;;AUp2BA;EACI,yBRIiB;EQHjB,WAAA;AVu2BJ;AUr2BI;EACI,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,WAAA;EACA,cRDU;EQEV,eAAA;EAMA,cRRU;AF02BlB;AUt2BQ;EARJ;IASQ,eAAA;EVy2BV;AACF;AUr2BQ;EACI,qBAAA;EACA,0DAAA;EACA,YAAA;EACA,YAAA;EACA,4BAAA;EACA,wBAAA;AVu2BZ;AUr2BY;EARJ;IASQ,WAAA;IACA,YAAA;EVw2Bd;AACF;AUp2BQ;EACI,qBAAA;EACA,0DAAA;EACA,YAAA;EACA,YAAA;EACA,4BAAA;EACA,wBAAA;EACA,eAAA;AVs2BZ;AUp2BY;EATJ;IAUQ,WAAA;IACA,YAAA;EVu2Bd;AACF;;AWp5BA;EACI,aAAA;EACA,eAAA;EACA,yCAAA;EACA,WAAA;EACA,iBAAA;EACA,aAAA;EACA,kBAAA;EACA,OAAA;AXu5BJ;AWr5BI;EAVJ;IAWQ,sBAAA;EXw5BN;AACF;AWr5BI;EACI,qBAAA;EACA,0DAAA;EACA,4BAAA;EACA,sBAAA;EACA,YAAA;EACA,aAAA;EACA,kBAAA;AXu5BR;AWr5BQ;EATJ;IAUQ,kBAAA;IACA,iBAAA;EXw5BV;AACF;AWr5BI;EACI,aAAA;EACA,sBAAA;EACA,eAAA;EACA,yBAAA;EACA,cAAA;AXu5BR;AWr5BQ;EAPJ;IAQQ,WAAA;EXw5BV;AACF;AWt5BQ;EACI,aAAA;AXw5BZ;AWt5BY;EAHJ;IAIO,kBAAA;EXy5Bb;AACF;;AYv8BA;EACI,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;AZ08BJ;;AYv8BA;EACI,yCAAA;EACA,UAAA;EACA,WAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,cAAA;EACA,kBAAA;EACA,iBAAA;AZ08BJ;AYx8BI;EAXJ;IAYQ,UAAA;EZ28BN;AACF;AYz8BI;EAfJ;IAgBQ,WAAA;EZ48BN;AACF;AY18BI;EACI,kBAAA;EACA,gBAAA;EACA,iBAAA;EACA,cV1BU;EU2BV,0CAAA;EACA,UAAA;EACA,kBAAA;AZ48BR;AY18BQ;EATJ;IAUQ,iBAAA;EZ68BV;AACF;AY38BQ;EAbJ;IAcQ,UAAA;IACA,iBAAA;EZ88BV;AACF;AY78BQ;EAjBJ;IAkBQ,UAAA;EZg9BV;AACF;AY78BI;EACI,qBAAA;EACA,YAAA;EACA,aAAA;EACA,0DAAA;EACA,sBAAA;EACA,4BAAA;AZ+8BR;AY78BQ;EARJ;IASQ,YAAA;IACA,aAAA;EZg9BV;AACF;AY98BQ;EAbJ;IAcM,YAAA;IACA,aAAA;EZi9BR;AACF;;AajhCA;EACI,kBAAA;EACA,MAAA;EACA,WAAA;EACA,YAAA;EACA,UAAA;EACA,uCAAA;AbohCJ;AanhCI;EACI,cAAA;EACA,UAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,yBXbU;EWcV,kBAAA;AbqhCR;AaphCQ;EACI,SAAA;EACA,cXZK;EWaL,mBAAA;AbshCZ;AanhCQ;EACI,kBAAA;EACA,OAAA;EACA,SAAA;EACA,qBAAA;EACA,0DAAA;EACA,WAAA;EACA,YAAA;EACA,sBAAA;AbqhCZ;;AcnjCA;EACI,aAAA;EACA,OAAA;EACA,gBAAA;EACA,eAAA;EACA,iBAAA;AdsjCJ;AcnjCI;EARJ;IASQ,sBAAA;EdsjCN;AACF;AcpjCI;EACI,UAAA;EACA,YAAA;AdsjCR;AcnjCQ;EALJ;IAMQ,WAAA;IACA,iBAAA;EdsjCV;AACF;AcpjCQ;EACI,aAAA;EACA,sBAAA;EACA,gBAAA;EACA,UAAA;EACA,SAAA;EACA,yCAAA;EACA,kBAAA;AdsjCZ;AcnjCY;EACI,yBAAA;EACA,kBAAA;EACA,eAAA;AdqjChB;AcnjCgB;EACG,cZ9BD;AFmlClB;AcljCgB;EACI,qBAAA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,yBAAA;AdojCpB;Ac3iCI;EACI,aAAA;EACA,yCAAA;EACA,kBAAA;EACA,YAAA;EACA,cAAA;EACA,eAAA;EACA,WAAA;EACA,UAAA;Ad6iCR;Ac3iCQ;EAVJ;IAWQ,WAAA;Ed8iCV;AACF;Ac5iCQ;EACI,aAAA;EACA,sBAAA;EACA,SAAA;Ad8iCZ;Ac1iCQ;EACI,aAAA;EACA,eAAA;EACA,OAAA;Ad4iCZ;AcziCY;EACI,YAAA;EACA,aAAA;EACA,kBAAA;EACA,kBAAA;Ad2iChB;AcxiCY;EACI,gBAAA;EACA,SAAA;EACA,UAAA;EACA,aAAA;EACA,sBAAA;EACA,SAAA;EACA,YAAA;EACA,cAAA;Ad0iChB;AcriCQ;EACI,aAAA;AduiCZ;;AchiCA;EACI,SAAA;AdmiCJ;;AchiCA;EACI,eAAA;AdmiCJ;;AevpCA;EACI,aAAA;EACA,yCAAA;EACA,kBAAA;EACA,YAAA;EACA,cAAA;EACA,eAAA;EACA,WAAA;EACA,iBAAA;Af0pCJ;AevpCI;EAXJ;IAYQ,WAAA;Ef0pCN;AACF;AexpCI;EACI,aAAA;EACA,eAAA;EACA,OAAA;Af0pCR;AevpCQ;EACI,YAAA;EACA,aAAA;EACA,kBAAA;EACA,kBAAA;AfypCZ;AetpCQ;EACI,gBAAA;EACA,SAAA;EACA,UAAA;EACA,aAAA;EACA,sBAAA;EACA,SAAA;EACA,YAAA;EACA,cAAA;AfwpCZ","sourcesContent":["/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */\r\n\r\n/* Document\r\n   ========================================================================== */\r\n\r\n/**\r\n * 1. Correct the line height in all browsers.\r\n * 2. Prevent adjustments of font size after orientation changes in iOS.\r\n */\r\n\r\n html {\r\n    line-height: 1.15; /* 1 */\r\n    -webkit-text-size-adjust: 100%; /* 2 */\r\n  }\r\n  \r\n  /* Sections\r\n     ========================================================================== */\r\n  \r\n  /**\r\n   * Remove the margin in all browsers.\r\n   */\r\n  \r\n  body {\r\n    margin: 0;\r\n  }\r\n  \r\n  /**\r\n   * Render the `main` element consistently in IE.\r\n   */\r\n  \r\n  main {\r\n    display: block;\r\n  }\r\n  \r\n  /**\r\n   * Correct the font size and margin on `h1` elements within `section` and\r\n   * `article` contexts in Chrome, Firefox, and Safari.\r\n   */\r\n  \r\n  h1 {\r\n    font-size: 2em;\r\n    margin: 0.67em 0;\r\n  }\r\n  \r\n  /* Grouping content\r\n     ========================================================================== */\r\n  \r\n  /**\r\n   * 1. Add the correct box sizing in Firefox.\r\n   * 2. Show the overflow in Edge and IE.\r\n   */\r\n  \r\n  hr {\r\n    box-sizing: content-box; /* 1 */\r\n    height: 0; /* 1 */\r\n    overflow: visible; /* 2 */\r\n  }\r\n  \r\n  /**\r\n   * 1. Correct the inheritance and scaling of font size in all browsers.\r\n   * 2. Correct the odd `em` font sizing in all browsers.\r\n   */\r\n  \r\n  pre {\r\n    font-family: monospace, monospace; /* 1 */\r\n    font-size: 1em; /* 2 */\r\n  }\r\n  \r\n  /* Text-level semantics\r\n     ========================================================================== */\r\n  \r\n  /**\r\n   * Remove the gray background on active links in IE 10.\r\n   */\r\n  \r\n  a {\r\n    background-color: transparent;\r\n  }\r\n  \r\n  /**\r\n   * 1. Remove the bottom border in Chrome 57-\r\n   * 2. Add the correct text decoration in Chrome, Edge, IE, Opera, and Safari.\r\n   */\r\n  \r\n  abbr[title] {\r\n    border-bottom: none; /* 1 */\r\n    text-decoration: underline; /* 2 */\r\n    text-decoration: underline dotted; /* 2 */\r\n  }\r\n  \r\n  /**\r\n   * Add the correct font weight in Chrome, Edge, and Safari.\r\n   */\r\n  \r\n  b,\r\n  strong {\r\n    font-weight: bolder;\r\n  }\r\n  \r\n  /**\r\n   * 1. Correct the inheritance and scaling of font size in all browsers.\r\n   * 2. Correct the odd `em` font sizing in all browsers.\r\n   */\r\n  \r\n  code,\r\n  kbd,\r\n  samp {\r\n    font-family: monospace, monospace; /* 1 */\r\n    font-size: 1em; /* 2 */\r\n  }\r\n  \r\n  /**\r\n   * Add the correct font size in all browsers.\r\n   */\r\n  \r\n  small {\r\n    font-size: 80%;\r\n  }\r\n  \r\n  /**\r\n   * Prevent `sub` and `sup` elements from affecting the line height in\r\n   * all browsers.\r\n   */\r\n  \r\n  sub,\r\n  sup {\r\n    font-size: 75%;\r\n    line-height: 0;\r\n    position: relative;\r\n    vertical-align: baseline;\r\n  }\r\n  \r\n  sub {\r\n    bottom: -0.25em;\r\n  }\r\n  \r\n  sup {\r\n    top: -0.5em;\r\n  }\r\n  \r\n  /* Embedded content\r\n     ========================================================================== */\r\n  \r\n  /**\r\n   * Remove the border on images inside links in IE 10.\r\n   */\r\n  \r\n  img {\r\n    border-style: none;\r\n  }\r\n  \r\n  /* Forms\r\n     ========================================================================== */\r\n  \r\n  /**\r\n   * 1. Change the font styles in all browsers.\r\n   * 2. Remove the margin in Firefox and Safari.\r\n   */\r\n  \r\n  button,\r\n  input,\r\n  optgroup,\r\n  select,\r\n  textarea {\r\n    font-family: inherit; /* 1 */\r\n    font-size: 100%; /* 1 */\r\n    line-height: 1.15; /* 1 */\r\n    margin: 0; /* 2 */\r\n  }\r\n  \r\n  /**\r\n   * Show the overflow in IE.\r\n   * 1. Show the overflow in Edge.\r\n   */\r\n  \r\n  button,\r\n  input { /* 1 */\r\n    overflow: visible;\r\n  }\r\n  \r\n  /**\r\n   * Remove the inheritance of text transform in Edge, Firefox, and IE.\r\n   * 1. Remove the inheritance of text transform in Firefox.\r\n   */\r\n  \r\n  button,\r\n  select { /* 1 */\r\n    text-transform: none;\r\n  }\r\n  \r\n  /**\r\n   * Correct the inability to style clickable types in iOS and Safari.\r\n   */\r\n  \r\n  button,\r\n  [type=\"button\"],\r\n  [type=\"reset\"],\r\n  [type=\"submit\"] {\r\n    -webkit-appearance: button;\r\n  }\r\n  \r\n  /**\r\n   * Remove the inner border and padding in Firefox.\r\n   */\r\n  \r\n  button::-moz-focus-inner,\r\n  [type=\"button\"]::-moz-focus-inner,\r\n  [type=\"reset\"]::-moz-focus-inner,\r\n  [type=\"submit\"]::-moz-focus-inner {\r\n    border-style: none;\r\n    padding: 0;\r\n  }\r\n  \r\n  /**\r\n   * Restore the focus styles unset by the previous rule.\r\n   */\r\n  \r\n  button:-moz-focusring,\r\n  [type=\"button\"]:-moz-focusring,\r\n  [type=\"reset\"]:-moz-focusring,\r\n  [type=\"submit\"]:-moz-focusring {\r\n    outline: 1px dotted ButtonText;\r\n  }\r\n  \r\n  /**\r\n   * Correct the padding in Firefox.\r\n   */\r\n  \r\n  fieldset {\r\n    padding: 0.35em 0.75em 0.625em;\r\n  }\r\n  \r\n  /**\r\n   * 1. Correct the text wrapping in Edge and IE.\r\n   * 2. Correct the color inheritance from `fieldset` elements in IE.\r\n   * 3. Remove the padding so developers are not caught out when they zero out\r\n   *    `fieldset` elements in all browsers.\r\n   */\r\n  \r\n  legend {\r\n    box-sizing: border-box; /* 1 */\r\n    color: inherit; /* 2 */\r\n    display: table; /* 1 */\r\n    max-width: 100%; /* 1 */\r\n    padding: 0; /* 3 */\r\n    white-space: normal; /* 1 */\r\n  }\r\n  \r\n  /**\r\n   * Add the correct vertical alignment in Chrome, Firefox, and Opera.\r\n   */\r\n  \r\n  progress {\r\n    vertical-align: baseline;\r\n  }\r\n  \r\n  /**\r\n   * Remove the default vertical scrollbar in IE 10+.\r\n   */\r\n  \r\n  textarea {\r\n    overflow: auto;\r\n  }\r\n  \r\n  /**\r\n   * 1. Add the correct box sizing in IE 10.\r\n   * 2. Remove the padding in IE 10.\r\n   */\r\n  \r\n  [type=\"checkbox\"],\r\n  [type=\"radio\"] {\r\n    box-sizing: border-box; /* 1 */\r\n    padding: 0; /* 2 */\r\n  }\r\n  \r\n  /**\r\n   * Correct the cursor style of increment and decrement buttons in Chrome.\r\n   */\r\n  \r\n  [type=\"number\"]::-webkit-inner-spin-button,\r\n  [type=\"number\"]::-webkit-outer-spin-button {\r\n    height: auto;\r\n  }\r\n  \r\n  /**\r\n   * 1. Correct the odd appearance in Chrome and Safari.\r\n   * 2. Correct the outline style in Safari.\r\n   */\r\n  \r\n  [type=\"search\"] {\r\n    -webkit-appearance: textfield; /* 1 */\r\n    outline-offset: -2px; /* 2 */\r\n  }\r\n  \r\n  /**\r\n   * Remove the inner padding in Chrome and Safari on macOS.\r\n   */\r\n  \r\n  [type=\"search\"]::-webkit-search-decoration {\r\n    -webkit-appearance: none;\r\n  }\r\n  \r\n  /**\r\n   * 1. Correct the inability to style clickable types in iOS and Safari.\r\n   * 2. Change font properties to `inherit` in Safari.\r\n   */\r\n  \r\n  ::-webkit-file-upload-button {\r\n    -webkit-appearance: button; /* 1 */\r\n    font: inherit; /* 2 */\r\n  }\r\n  \r\n  /* Interactive\r\n     ========================================================================== */\r\n  \r\n  /*\r\n   * Add the correct display in Edge, IE 10+, and Firefox.\r\n   */\r\n  \r\n  details {\r\n    display: block;\r\n  }\r\n  \r\n  /*\r\n   * Add the correct display in all browsers.\r\n   */\r\n  \r\n  summary {\r\n    display: list-item;\r\n  }\r\n  \r\n  /* Misc\r\n     ========================================================================== */\r\n  \r\n  /**\r\n   * Add the correct display in IE 10+.\r\n   */\r\n  \r\n  template {\r\n    display: none;\r\n  }\r\n  \r\n  /**\r\n   * Add the correct display in IE 10.\r\n   */\r\n  \r\n  [hidden] {\r\n    display: none;\r\n  }\r\n\r\n  section, main, footer, header, article{\r\n    display: block;\r\n  }\r\n  *{\r\n    box-sizing: border-box;\r\n  }\r\n  ","@import \"abstracts/variables\";\r\n@import \"abstracts/mixins\";\r\n\r\n\r\n//Base\r\n@import \"base/normalize\";\r\n@import \"base/base\";\r\n@import url('https://fonts.googleapis.com/css2?family=Aladin&family=Aleo:ital,wght@0,400;0,700;1,700&family=Roboto:wght@100;300;400;500;700&display=swap');\r\n\r\n//Components\r\n@import \"components/button\";\r\n@import \"components/navigation\";\r\n@import \"components/logo\";\r\n@import \"components/audio\";\r\n\r\n\r\n//layout\r\n@import \"layout/header\";\r\n@import \"layout/start\";\r\n@import \"layout/footer\";\r\n@import \"layout/guess\";\r\n@import \"layout/results\";\r\n@import \"layout/message\";\r\n@import \"layout/select\";\r\n@import \"layout/gallery\";\r\n\r\n\r\n","\r\nhtml{\r\n    font-size: 10px;\r\n}\r\n\r\nbody{\r\n    font-size: 1.6rem;\r\n    font-family: \"Roboto\", Verdana, Geneva, Tahoma, sans-serif;\r\n    scroll-behavior: smooth;\r\n    margin: 0 auto;\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: center;\r\n    background-color: $color-primary;\r\n}\r\n\r\n.main{\r\n    position: relative;\r\n}\r\n\r\n.body__wrapper{\r\n    margin: 0 auto;\r\n    width: 70%;\r\n\r\n    @media screen and (max-width: 1200px) {\r\n        width: 90%;\r\n    }\r\n}\r\n\r\n\r\n\r\n\r\n.button_nav{\r\n    @include font(50px, 120%, 400);\r\n\r\n}\r\n\r\n.text_btn{\r\n    @include font(16px, 140%, 500);\r\n\r\n}\r\n\r\n.text_smallParagraph{\r\n    @include font(15px, 120%, 300);\r\n\r\n}\r\n\r\n.feed__mainText{\r\n    @include font(16px, 130%, 400);\r\n\r\n}\r\n.feed__commentText{\r\n    @include font(16px, 130%, 500);\r\n\r\n}\r\n\r\n.text__donate{\r\n    @include font(16.3px, 140%, 400);\r\n}\r\n\r\nh4{\r\n    @include font(20px, 140%, 700); \r\n}\r\n\r\n.hidden{\r\n    display: none;\r\n}\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n","$color-primary:#f0c592;\r\n$color-additional:#131212;\r\n$color-buttons:#c93a3d;\r\n$color-button-hover:#1e797f;\r\n$color-categories:#1e797f;\r\n$color-button-active:#f0c592;\r\n$color-text-dark:#333B41;\r\n$color-white:#FFFFFF;\r\n$color-text-light:#F1F3F2;\r\n\r\n\r\n$breakpoints: (\r\n    'small':(min-width: 320px),\r\n    'medium': (min-width: 768px),\r\n    'large': (min-width: 1280px),\r\n);\r\n\r\n\r\n\r\n\r\n\r\n\r\n","@mixin font($size, $height, $weight, $style:normal){\r\n   font-size: $size;\r\n   font-weight: $weight;\r\n   font-style: $style;\r\n   line-height: $height;\r\n    }\r\n\r\n    //padding from px to vw\r\n\r\n@mixin padding($media, $top:0, $right:0, $bottom:0, $left:0){\r\n     padding: #{calc($top/$media*100)}vw #{calc($right/$media*100)}vw #{calc($bottom/$media*100)}vw #{calc($left/$media*100)}vw;\r\n       }\r\n\r\n@mixin height($media, $height){\r\n  height: #{calc($height/$media*100)}vw;\r\n}     \r\n\r\n@mixin width($media, $width) {\r\n  width: #{calc($width/$media*100)}vw;\r\n}\r\n\r\n@mixin gap($media, $gap){\r\n  gap: #{calc($gap/$media*100)}vw;\r\n}\r\n@mixin row-gap($media, $row-gap) {\r\n  row-gap: #{calc($row-gap/$media*100)}vw;\r\n}\r\n\r\n@mixin column-gap($media, $column-gap) {\r\n  column-gap: #{calc($column-gap/$media*100)}vw;\r\n}\r\n\r\n@mixin margin($media, $top:0, $right:0, $bottom:0, $left:0){\r\n  margin: #{calc($top/$media*100)}vw #{calc($right/$media*100)}vw #{calc($bottom/$media*100)}vw #{calc($left/$media*100)}vw;\r\n    }\r\n\r\n@mixin left($media, $left:0){\r\n  left: #{calc($left/$media*100)}vw;\r\n}\r\n\r\n@mixin right($media, $right:0){\r\n  right: #{calc($right/$media*100)}vw;\r\n}\r\n@mixin top ($media, $top:0){\r\n  top: #{calc($top/$media*100)}vw;\r\n}\r\n@mixin bottom ($media, $bottom:0){\r\n  bottom: #{calc($bottom/$media*100)}vw;\r\n  \r\n}\r\n\r\n@mixin font-size ($media, $font-size) {\r\n  font-size: #{calc($font-size/$media*100)}vw;;\r\n}\r\n\r\n\r\n// Управление отзывчивостью.\r\n// @access public\r\n// @param {String} $breakpoint - точка останова\r\n// @requires $breakpoints\r\n@mixin respond-to($breakpoint) {\r\n  $raw-query: map-get($breakpoints, $breakpoint);\r\n\r\n  @if $raw-query {\r\n    $query: if(\r\n      type-of($raw-query) == 'string',\r\n      unquote($raw-query),\r\n      inspect($raw-query)\r\n    );\r\n\r\n    @media #{$query} {\r\n      @content;\r\n    }\r\n  } @else {\r\n  @error 'Не указано значение для `#{$breakpoint}`. '\r\n       + 'Пожалуйста, убедитесь, что точка останова объявлена в карте `$breakpoints`.';\r\n  }\r\n}\r\n    \r\n\r\n \r\n\r\n\r\n\r\n\r\n",".button__nav{\r\n    color: $color-text-light;\r\n    font-size: 48px;\r\n    line-height: 140%;\r\n    text-align: center;\r\n    text-transform: uppercase;\r\n    background: $color-buttons;\r\n    border-radius: 5px;\r\n    border-style: none;\r\n    font-family: \"Roboto\", Verdana, Geneva, Tahoma, sans-serif;\r\n    transition:all .3s;\r\n    cursor: pointer;\r\n    \r\n    \r\n    &:hover{\r\n        background-color: $color-button-hover;\r\n    }\r\n    &:active{\r\n        background: $color-button-active;\r\n    }\r\n}\r\n\r\n.start__button_sound{\r\n    position: absolute;\r\n    top: 10%;\r\n    right: 10%;\r\n    background-color: $color-buttons;\r\n    border-radius: 50%;\r\n    border-style: none;\r\n    box-shadow: 5px $color-text-dark;\r\n    padding: 0;\r\n\r\n    @media screen and (min-width: 768px) {\r\n        width: 100px;\r\n        height: 100px;\r\n    }\r\n\r\n    @media screen and (max-width: 768px) {\r\n        width: 50px;\r\n        height: 50px;\r\n    }\r\n\r\n    @media screen and (max-width: 500px) {\r\n        width: 30px;\r\n        height: 30px;\r\n    }\r\n\r\n    &:hover{\r\n        background-color: $color-button-hover;\r\n    }\r\n    .button__img_sound{\r\n        display: inline-block;\r\n        background-image: url(..//..//assets/icons/on_sound.png);\r\n        background-repeat: no-repeat;\r\n        background-position: center;\r\n        background-size: cover;\r\n       \r\n        @media screen and (min-width: 768px) {\r\n            width: 100px;\r\n            height: 100px;\r\n        }\r\n    \r\n        @media screen and (max-width: 768px) {\r\n            width: 50px;\r\n            height: 50px;\r\n        }\r\n\r\n        @media screen and (max-width: 500px) {\r\n            width: 30px;\r\n            height: 30px;\r\n        }\r\n    }\r\n\r\n}\r\n\r\n.sound_off{\r\n    .button__img_sound{\r\n        display: inline-block;\r\n        background-image: url(..//..//assets/icons/off_sound.png);\r\n        background-repeat: no-repeat;\r\n        background-position: center;\r\n        background-size: cover;\r\n       \r\n        @media screen and (min-width: 768px) {\r\n            width: 100px;\r\n            height: 100px;\r\n        }\r\n    \r\n        @media screen and (max-width: 768px) {\r\n            width: 50px;\r\n            height: 50px;\r\n        }\r\n\r\n        @media screen and (max-width: 500px) {\r\n            width: 30px;\r\n            height: 30px;\r\n        }\r\n\r\n    }\r\n}\r\n\r\n.button__img_volume{\r\n    display: inline-block;\r\n    background-image: url(..//..//assets/icons/volume_white.png);\r\n    background-color: $color-categories;\r\n    border-radius: 50%;\r\n    background-repeat: no-repeat;\r\n    background-position: center;\r\n    background-size: cover;\r\n    margin-left: 5px;\r\n    width: 30px;\r\n    height: 30px;\r\n    cursor: pointer;\r\n    \r\n   \r\n    &:hover{\r\n        background-image: url(..//..//assets/icons/volume_black.png);\r\n    }\r\n\r\n}\r\n\r\n.play__button_next{\r\n    width: 100%;\r\n    border-radius: 5px;\r\n    border-style: none ;\r\n    padding: 2rem;\r\n    font-weight: 700;\r\n    background-color: rgba(30, 121, 127, 0.2);\r\n    color:  rgba(30, 121, 127, 0.8);\r\n    margin-bottom: 3%;\r\n    cursor: pointer;\r\n}\r\n\r\n.play_again{\r\n    width: 60%;\r\n    color: $color-text-light;\r\n    background-color: $color-buttons;\r\n    height: 20%;\r\n    font-size: 3.6rem;\r\n    font-weight: 500;\r\n\r\n    &:hover{\r\n        scale: 1.05;\r\n    }\r\n\r\n    @media screen and (max-width: 1700px) {\r\n        width: 80%;\r\n    }\r\n\r\n    @media screen and (max-width: 500px) {\r\n        width: 100%;\r\n        font-size: 1.8rem;\r\n    }\r\n}\r\n\r\n\r\n\r\n.active{\r\n    background: $color-button-hover;\r\n    color: $color-text-light ;\r\n}\r\n\r\n.press{\r\n    background-color: $color-button-hover;\r\n}\r\n\r\n\r\n\r\n\r\n\r\n",".header__nav{\r\n  display:flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n  padding: 0;\r\n  margin: 0;\r\n\r\n  .nav__list{\r\n    display:flex;\r\n    flex-direction: row;\r\n    align-items: center;\r\n    justify-content: space-between;\r\n    padding: 0;\r\n    margin: 0;\r\n    gap: 2%;\r\n\r\n    .nav__item{\r\n      list-style: none;\r\n    }\r\n\r\n    .item_button{\r\n      margin-left: -10%;\r\n      margin-right: 10%;\r\n\r\n      @media screen and (max-width: 768px) {\r\n        margin-left: 0%;\r\n        margin-right: 3%;\r\n      }\r\n      \r\n\r\n    }\r\n\r\n}\r\n\r\n}\r\n\r\n\r\n\r\n",".img_logo{\r\n    display: inline-block;\r\n    background-image: url(..//..//assets/icons/logo.png);\r\n    background-size: contain;\r\n    background-repeat: no-repeat;\r\n    width: 70px;\r\n    height: 70px;\r\n\r\n    @media screen and (min-width: 768px) {\r\n        width: 100px;\r\n        height: 100px;\r\n    }\r\n    \r\n}",".audio-player{\r\n    width: 100%;\r\n    min-width: 100px;\r\n\r\n    .controls {\r\n        display: flex;\r\n        align-items: center;\r\n    }\r\n\r\n    \r\n    .playback-button {\r\n      display: flex;\r\n      align-items: center;\r\n      transition: .2s;\r\n      width: 40px;\r\n      height: 40px;\r\n      border: 2px solid #c93a3d;\r\n      justify-content: center;\r\n      border-radius: 50%;\r\n      margin-right: 20px;\r\n      margin-bottom: 12px;\r\n      cursor: pointer;\r\n\r\n      .button__img_sound{\r\n        display: inline-block;\r\n        background-image: url(..//..//assets/icons/on_sound.png);\r\n        background-repeat: no-repeat;\r\n        background-position: center;\r\n        background-size: cover;\r\n        width: 30px;\r\n        height: 30px;\r\n      }\r\n\r\n      .img-play{\r\n        transition: .2s;\r\n        width: 18px;\r\n        height: 18px;\r\n        align-self: center;\r\n      }\r\n      \r\n\r\n    }\r\n\r\n    .pause{\r\n      .button__img_sound{\r\n        display: inline-block;\r\n        background-image: url(..//..//assets/icons/off_sound.png);\r\n        background-repeat: no-repeat;\r\n        background-position: center;\r\n        background-size: cover;\r\n        width: 30px;\r\n        height: 30px;\r\n      }\r\n    \r\n    }\r\n}\r\n\r\n.timebar{\r\n  flex-grow: 1;\r\n  flex-shrink: 1;\r\n  flex-basis: 0%;\r\n  position: relative;\r\n}\r\n\r\n\r\n.timebar-bar {\r\n    height: 6px;\r\n    min-width: 100%;\r\n    background: linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) 0%, #f0c592 2.90146%, #c93a3d 100%);\r\n}\r\n\r\n.timebar-circle {\r\n  background-color:#1e797f;\r\n  width: 16px;\r\n  height: 16px;\r\n  border-radius: 50%;\r\n  position: absolute;\r\n  top: 0;\r\n  -webkit-transform: translate(-50%,calc(-50% + 2px));\r\n  transform: translate(-50%,calc(-50% + 2px));\r\n  box-shadow: 0 0 4px 0 rgb(0 0 0 / 20%);\r\n  cursor: pointer;\r\n  \r\n}\r\n\r\n.timebar-time-info {\r\n    margin-top: 8px;\r\n    font-size: 11px;\r\n    color: #d3d3d3;\r\n    display: flex;\r\n    justify-content: space-between;\r\n}\r\n\r\n\r\n.volume-block{\r\n  display: flex;\r\n  align-items: center;\r\n  position: relative;\r\n \r\n  .bar_volume{\r\n    display: none;\r\n    min-width: 10%;\r\n    background: linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) 75%, #f0c592 2.90146%, #c93a3d 100%);\r\n  }\r\n\r\n  .active{\r\n    display: block;\r\n  }\r\n\r\n}\r\n\r\n\r\n\r\n","header{\r\n  width: 100%; \r\n  margin: 0 auto;\r\n  background-color: $color-primary;\r\n}\r\n\r\n.header__wrapper{\r\n  height: 10%;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n  padding: 2%;\r\n}\r\n\r\n.header__wrapper_play{\r\n  display: flex;\r\n  flex-direction: column;\r\n  padding-top: 2%;\r\n  padding-bottom: 0;\r\n\r\n  .logo-block{\r\n    display: flex;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n  }\r\n\r\n  .score{\r\n    text-align: center;\r\n    font-size: 32px;\r\n    font-weight: 200;\r\n    color: $color-text-light;\r\n    margin: 0;\r\n  }\r\n\r\n  .categories-block{\r\n    display: flex;\r\n    flex-direction: row;\r\n    justify-content:space-around;\r\n    flex-wrap: wrap;\r\n    list-style: none;\r\n    font-size: 20px;\r\n    padding: 0;\r\n    margin-bottom: 0;\r\n    background-color: $color-categories;\r\n    border-radius: 5px;\r\n    gap:10px;\r\n\r\n    .category{\r\n      padding: 1rem;\r\n      font-weight: 500;\r\n    }\r\n     \r\n    .category_selected{\r\n      color: $color-buttons;\r\n    }\r\n   \r\n  }\r\n\r\n}\r\n\r\n\r\n\r\n.img_house{\r\n  display: inline-block;\r\n  background-image: url(..//..//assets/icons/house.png);\r\n  background-repeat: no-repeat;\r\n  background-position: center;\r\n  background-size: cover;\r\n  background-position: right;\r\n\r\n  @media screen and (min-width: 768px) {\r\n      width: 69.2px;\r\n      height: 69.2px;\r\n  }\r\n\r\n  @media screen and (max-width: 768px) {\r\n      width: 50px;\r\n      height: 50px;\r\n  }\r\n\r\n  &:hover{\r\n    background-image: url(..//..//assets/icons/house_black.png);\r\n  }\r\n  \r\n}\r\n\r\n.img_gallery{\r\n  display: inline-block;\r\n  background-image: url(..//..//assets/icons/gallery_white.png);\r\n  background-repeat: no-repeat;\r\n  background-position: center;\r\n  background-size: contain;\r\n  background-position: right;\r\n\r\n\r\n  @media screen and (min-width: 768px) {\r\n      width: 69.2px;\r\n      height: 69.2px;\r\n  }\r\n\r\n  @media screen and (max-width: 768px) {\r\n      width: 50px;\r\n      height: 50px;\r\n  }\r\n\r\n  &:hover{\r\n    background-image: url(..//..//assets/icons/gallery_black.png);\r\n  }\r\n  \r\n}\r\n\r\n.img_lang{\r\n\r\n  display: inline-block;\r\n  background-image: url(..//..//assets/icons/ru_white.png);\r\n  background-repeat: no-repeat;\r\n  background-position: center;\r\n  background-size: cover;\r\n  background-position: right;\r\n  background-size: contain;\r\n\r\n  @media screen and (min-width: 768px) {\r\n      width: 40px;\r\n      height: 40px;\r\n  }\r\n\r\n  @media screen and (max-width: 768px) {\r\n      width: 30px;\r\n      height: 30px;\r\n  }\r\n\r\n  &:hover{\r\n    background-image: url(..//..//assets/icons/ru_black.png);\r\n  }\r\n\r\n}\r\n\r\n.en{\r\n  background-image: url(..//..//assets/icons/eng_white.png);\r\n\r\n  &:hover{\r\n    background-image: url(..//..//assets/icons/eng_white.png);\r\n  }\r\n\r\n}\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n    \r\n",".main__start{\r\n    position: relative;\r\n    .start-img{\r\n        width: 100%;\r\n        height: 80%;\r\n        border-radius: 5px;\r\n        border: 3px solid $color-categories;\r\n\r\n        @media screen and (max-width: 500px) {\r\n            width: 100%;\r\n            display: none;\r\n        }\r\n\r\n    } \r\n\r\n    .start-img_mobile{\r\n        @media screen and (min-width: 500px) {\r\n            display: none;\r\n        }\r\n\r\n        @media screen and (max-width: 500px) {\r\n          width: 100%;\r\n          border-radius: 5px;\r\n          border: 3px solid $color-categories;\r\n        }\r\n        \r\n    }\r\n}\r\n\r\n.main__wrapper{\r\n    display: flex;\r\n    flex-direction: column;\r\n}\r\n",".footer{\r\n    background-color: $color-button-active;\r\n    height: 20%;\r\n\r\n    .footer__wrapper{\r\n        display: flex;\r\n        align-items: center;\r\n        justify-content: space-between;\r\n        padding: 1%;\r\n        color:$color-text-light;\r\n        font-size: 30px;\r\n\r\n        @media screen and (max-width: 569px) {\r\n            font-size: 16px;\r\n        }\r\n\r\n        color: $color-text-light;\r\n\r\n        .img-github{\r\n            display: inline-block;\r\n            background-image: url(..//..//assets/icons/GitHub-Symbol.png);\r\n            width: 140px;\r\n            height: 70px;\r\n            background-repeat: no-repeat;\r\n            background-size: contain;\r\n\r\n            @media screen and (max-width: 569px) {\r\n                width: 70px;\r\n                height: 35px;\r\n            }\r\n\r\n        }\r\n\r\n        .rssschool{\r\n            display: inline-block;\r\n            background-image: url(..//..//assets/icons/rs_school_js.svg);\r\n            width: 140px;\r\n            height: 40px;\r\n            background-repeat: no-repeat;\r\n            background-size: contain;\r\n            margin-left: 2%;\r\n\r\n            @media screen and (max-width: 569px) {\r\n                width: 70px;\r\n                height: 16px;\r\n            }\r\n\r\n        }\r\n\r\n    }\r\n}\r\n",".guess__wrapper{\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    background-color: rgba($color-categories, 0.2);\r\n    padding: 2%;\r\n    margin-bottom: 2%;\r\n    margin-top: 0;\r\n    border-radius: 5px;\r\n    gap: 3%;\r\n\r\n    @media screen and (max-width: 569px) {\r\n        flex-direction: column;\r\n    }\r\n\r\n\r\n    .img-guess{\r\n        display: inline-block;\r\n        background-image: url(..//..//assets/img/img_guess.jpg);\r\n        background-repeat: no-repeat;\r\n        background-size: cover;\r\n        width: 200px;\r\n        height: 155px;\r\n        border-radius: 5px;\r\n\r\n        @media screen and (max-width: 569px) {\r\n            align-self: center;\r\n            margin-bottom: 3%;\r\n        }\r\n    }\r\n\r\n    .block-guess{\r\n        display: flex;\r\n        flex-direction: column;\r\n        flex-wrap: wrap;\r\n        width: calc(100% - 240px);\r\n        flex-shrink: 0;\r\n\r\n        @media screen and (max-width: 569px) {\r\n            width: 100%;\r\n        }\r\n\r\n        .name-guess{\r\n            margin-top: 0;\r\n\r\n            @media screen and (max-width: 569px) {\r\n               text-align: center;\r\n            }\r\n\r\n\r\n        }\r\n\r\n    }\r\n\r\n}\r\n\r\n",".results__wrapper{\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: center;\r\n    align-items: center;\r\n}\r\n\r\n.results-block{\r\n    background-color: rgba(30, 121, 127, 0.2);\r\n    width: 60%;\r\n    height: 40%;\r\n    display: flex;\r\n    flex-direction: column;\r\n    align-items: center;\r\n    margin: 0 auto;\r\n    border-radius: 5px;\r\n    margin-bottom: 3%;\r\n\r\n    @media screen and (max-width: 1700px) {\r\n        width: 80%;\r\n    }\r\n\r\n    @media screen and (max-width: 500px) {\r\n        width: 100%;\r\n    }\r\n\r\n    .text-results{\r\n        text-align: center;   \r\n        font-weight: 700;\r\n        font-size: 3.2rem;\r\n        color: $color-categories;\r\n        background-color: rgba($color-text-light, 0.5);\r\n        width: 40%;\r\n        border-radius: 5px;\r\n\r\n        @media screen and (min-width: 1000px) {\r\n            font-size: 4.8rem;\r\n        }\r\n\r\n        @media screen and (max-width: 700px) {\r\n            width: 50%;\r\n            font-size: 2.4rem;\r\n        }\r\n        @media screen and (max-width: 500px) {\r\n            width: 70%;\r\n        }\r\n    }\r\n\r\n    .img-results{\r\n        display: inline-block;\r\n        width: 320px;\r\n        height: 280px;\r\n        background-image: url(..//..//assets/img/hen_result.png);\r\n        background-size: cover;\r\n        background-repeat: no-repeat;\r\n\r\n        @media screen and (min-width: 500px) and (max-width: 700px) {\r\n            width: 220px;\r\n            height: 200px;\r\n        }\r\n\r\n        @media screen and (max-width: 500px) {\r\n          width: 120px;\r\n          height: 100px;\r\n        }\r\n       \r\n    }\r\n\r\n\r\n}",".message__wrapper{\r\n    position: absolute;\r\n    top:0;\r\n    width: 100%;\r\n    height: 100%;\r\n    z-index:2;\r\n    background-color: rgba($color: #333B41, $alpha: 0.5) ;\r\n    .message_block{\r\n        margin: 0 auto;\r\n        width: 80%;\r\n        position: relative;\r\n        display: flex;\r\n        flex-direction: column;\r\n        align-items: center;\r\n        background-color: $color-additional;\r\n        padding: 20px 10px;\r\n        h1{\r\n            margin: 0;\r\n            color: $color-text-dark;\r\n            margin-bottom: 10px;\r\n        }\r\n        \r\n        .cross{ \r\n            position: absolute;\r\n            top: 2%;\r\n            right: 2%;\r\n            display: inline-block;\r\n            background-image: url('../../assets/svg/cross.svg');\r\n            width: 15px;\r\n            height: 15px;\r\n            background-size: cover;\r\n    \r\n        }\r\n    }\r\n\r\n}",".select{\r\n    display: flex;\r\n    gap: 2%;\r\n    font-weight: 500;\r\n    flex-wrap: wrap;\r\n    margin-bottom: 3%;\r\n    \r\n\r\n    @media screen and (max-width: 569px) {\r\n        flex-direction: column;\r\n    }\r\n\r\n    .answer-wrapper{\r\n        width: 33%;\r\n        height: 100%;\r\n        \r\n\r\n        @media screen and (max-width: 569px) {\r\n            width: 100%;\r\n            margin-bottom: 2%;\r\n        }\r\n        \r\n        .answer-list{\r\n            display: flex;\r\n            flex-direction: column;\r\n            list-style: none;\r\n            padding: 0;\r\n            margin: 0;\r\n            background-color: rgba(30, 121, 127, 0.2);\r\n            border-radius: 5px;\r\n           \r\n\r\n            .answer-item{\r\n                border: 1px solid $color-primary;\r\n                padding: 1rem 3rem;\r\n                cursor: pointer;\r\n            \r\n                &:hover{\r\n                   color: $color-text-light;\r\n                }\r\n\r\n                .answer-indicator{\r\n                    display: inline-block;\r\n                    margin-right: 1rem;\r\n                    width: 10px;\r\n                    height: 10px;\r\n                    border-radius: 50%;\r\n                    border: 1px solid $color-text-dark;\r\n                }\r\n\r\n            }\r\n\r\n        }\r\n\r\n    }\r\n\r\n    .card-wrapper{\r\n        display: flex;\r\n        background-color: rgba(30, 121, 127, 0.2);\r\n        border-radius: 5px;\r\n        flex-grow: 1;\r\n        flex-shrink: 0;\r\n        flex-wrap: wrap;\r\n        padding: 2%;\r\n        width: 33%;\r\n\r\n        @media screen and (max-width: 569px) {\r\n            width: 100%;\r\n        }\r\n\r\n        .instructions{\r\n            display: flex;\r\n            flex-direction: column;\r\n            margin: 0;\r\n        }\r\n        \r\n        \r\n        .card-body{\r\n            display: flex;\r\n            flex-wrap: wrap;\r\n            gap:2%;\r\n           \r\n\r\n            .img-bird{\r\n                width: 200px;\r\n                height: 155px;\r\n                border-radius: 5px;\r\n                align-self: center;\r\n            }\r\n\r\n            .card-list{\r\n                list-style: none;\r\n                margin: 0;\r\n                padding: 0;\r\n                display: flex;\r\n                flex-direction: column;\r\n                gap: 1rem;\r\n                flex-grow: 1;\r\n                flex-shrink: 1;\r\n\r\n            }\r\n        }\r\n\r\n        .hidden{\r\n            display: none;\r\n        }\r\n\r\n    }\r\n\r\n}\r\n\r\n.bird-name{\r\n    margin: 0;\r\n}\r\n\r\n.bird-description{\r\n    max-width: 100%;\r\n}\r\n\r\n",".card-wrapper{\r\n    display: flex;\r\n    background-color: rgba(30, 121, 127, 0.2);\r\n    border-radius: 5px;\r\n    flex-grow: 1;\r\n    flex-shrink: 0;\r\n    flex-wrap: wrap;\r\n    padding: 2%;\r\n    margin-bottom: 3%;\r\n\r\n\r\n    @media screen and (max-width: 569px) {\r\n        width: 100%;\r\n    }\r\n\r\n    .card-body{\r\n        display: flex;\r\n        flex-wrap: wrap;\r\n        gap:2%;\r\n       \r\n\r\n        .img-bird{\r\n            width: 200px;\r\n            height: 155px;\r\n            border-radius: 5px;\r\n            align-self: center;\r\n        }\r\n\r\n        .card-list{\r\n            list-style: none;\r\n            margin: 0;\r\n            padding: 0;\r\n            display: flex;\r\n            flex-direction: column;\r\n            gap: 1rem;\r\n            flex-grow: 1;\r\n            flex-shrink: 1;\r\n\r\n        }\r\n    }\r\n}"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/assets/icons/GitHub-Symbol.png":
/*!********************************************!*\
  !*** ./src/assets/icons/GitHub-Symbol.png ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "GitHub-Symbol.png";

/***/ }),

/***/ "./src/assets/icons/eng_white.png":
/*!****************************************!*\
  !*** ./src/assets/icons/eng_white.png ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "eng_white.png";

/***/ }),

/***/ "./src/assets/icons/gallery_black.png":
/*!********************************************!*\
  !*** ./src/assets/icons/gallery_black.png ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "gallery_black.png";

/***/ }),

/***/ "./src/assets/icons/gallery_white.png":
/*!********************************************!*\
  !*** ./src/assets/icons/gallery_white.png ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "gallery_white.png";
...
module.exports = __webpack_require__.p + "house.png";

/***/ }),

/***/ "./src/assets/icons/house_black.png":
/*!******************************************!*\
  !*** ./src/assets/icons/house_black.png ***!
  \******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "house_black.png";
...
/***/ "./src/assets/icons/off_sound.png":
/*!****************************************!*\
  !*** ./src/assets/icons/off_sound.png ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "off_sound.png";

/***/ }),

/***/ "./src/assets/icons/on_sound.png":
/*!***************************************!*\
  !*** ./src/assets/icons/on_sound.png ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "on_sound.png";
...
/***/ "./src/assets/icons/ru_black.png":
/*!***************************************!*\
  !*** ./src/assets/icons/ru_black.png ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "ru_black.png";

/***/ }),

/***/ "./src/assets/icons/ru_white.png":
/*!***************************************!*\
  !*** ./src/assets/icons/ru_white.png ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "ru_white.png";

/***/ }),

/***/ "./src/assets/icons/volume_black.png":
/*!*******************************************!*\
  !*** ./src/assets/icons/volume_black.png ***!
  \*******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "volume_black.png";

/***/ }),

/***/ "./src/assets/icons/volume_white.png":
/*!*******************************************!*\
  !*** ./src/assets/icons/volume_white.png ***!
  \*******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "volume_white.png";

/***/ }),

/***/ "./src/assets/img/hen_result.png":
/*!***************************************!*\
  !*** ./src/assets/img/hen_result.png ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "hen_result.png";

/***/ }),

/***/ "./src/assets/img/img_guess.jpg":
/*!**************************************!*\
  !*** ./src/assets/img/img_guess.jpg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "img_guess.jpg";
...
/******/ })()
;
//# sourceMappingURL=bundle19745f85d70fa382984d.js.map