...
if (document.querySelector('.play')) {
  ...
  var thumb = document.querySelector('.timebar-circle');
  var timeBar = document.querySelector('.timebar');
  var progress = document.querySelector('.timebar-bar');
  var block = document.querySelector('.block-guess');
  var buttonVolume = block.querySelector('.button__img_volume');
  var barVolume = block.querySelector('.bar_volume');
  var blockSelect = document.querySelector('.select');
  var thumbSelect = blockSelect.querySelector('.timebar-circle');
  var timeBarSelect = blockSelect.querySelector('.timebar');
  var progressSelect = blockSelect.querySelector('.timebar-bar');
  var buttonVolumeSelect = blockSelect.querySelector('.button__img_volume');
  var barVolumeSelect = blockSelect.querySelector('.bar_volume');
  var progressValue;
  var progressValueSelect;
  var newTimeAudio;
  var newTimeAudioSelect;
  var newLeft;
  var newLeftSelect;
  ...
  timeBar.onmousedown = function (event) {
    if (isPlay) {
      var onMouseMove = function onMouseMove(event) {
        newLeft = event.clientX - shiftX - timeBar.getBoundingClientRect().left; // the pointer is out of slider => lock the thumb within the bounaries
  ...
  buttonVolume.addEventListener('click', function () {
    ...
    buttonVolume.onmousedown = function (event) {
      ...
      var shiftX = event.clientX - buttonVolume.getBoundingClientRect().left; // shiftY not needed, the thumb moves only horizontally

      barVolume.addEventListener('mousemove', onMouseMove);
      barVolume.addEventListener('mouseup', onMouseUp);

      function onMouseMove(event) {
        var newLeft = event.clientX - shiftX - barVolume.getBoundingClientRect().left; // the pointer is out of slider => lock the thumb within the bounaries

        if (newLeft < 0) {
          newLeft = 0;
        }

        var rightEdge = barVolume.offsetWidth - buttonVolume.offsetWidth;
        ...
        audio.volume = newVolumeAudio; // buttonVolume.style.left = newLeft + 'px';
  ...
  buttonVolumeSelect.addEventListener('click', function () {
    barVolumeSelect.classList.toggle('active');

    buttonVolumeSelect.onmousedown = function (event) {
      event.preventDefault(); // prevent selection start (browser action)

      var shiftX = event.clientX - buttonVolumeSelect.getBoundingClientRect().left; // shiftY not needed, the thumb moves only horizontally

      barVolumeSelect.addEventListener('mousemove', onMouseMove);
      barVolumeSelect.addEventListener('mouseup', onMouseUp);

      function onMouseMove(event) {
        var newLeft = event.clientX - shiftX - barVolumeSelect.getBoundingClientRect().left; // the pointer is out of slider => lock the thumb within the bounaries

        if (newLeft < 0) {
          newLeft = 0;
        }

        var rightEdge = barVolumeSelect.offsetWidth;

        if (newLeft > rightEdge) {
          newLeft = rightEdge;
        }

        var progressVolume = newLeft / barVolumeSelect.offsetWidth;
        var newVolumeAudio = progressVolume;
        audioCard.volume = newVolumeAudio; // buttonVolume.style.left = newLeft + 'px';

        barVolumeSelect.style.background = "linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) ".concat(progressVolume * 100, "%, #f0c592 2.90146%, #c93a3d 100%)");
      }
  ...
  if (timeBarSelect) {
    timeBarSelect.onmousedown = function (event) {
      if (isPlay2) {
        var onMouseMove = function onMouseMove(event) {
          newLeftSelect = event.clientX - shiftX - timeBarSelect.getBoundingClientRect().left; // the pointer is out of slider => lock the thumb within the bounaries

          if (newLeftSelect < 0) {
            newLeftSelect = 0;
          }

          var rightEdge = timeBarSelect.offsetWidth - thumbSelect.offsetWidth;
          ...
          progressSelect.style.background = "linear-gradient(to right, #1e797f 0%, rgb(61, 133, 140) ".concat(progressValueSelect * 100, "%, #f0c592 2.90146%, #c93a3d 100%)");
        };
        ...
        var shiftX = event.clientX - thumbSelect.getBoundingClientRect().left; // shiftY not needed, the thumb moves only horizontally
...
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/ru_white.png */ "./src/assets/icons/ru_white.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/ru_black.png */ "./src/assets/icons/ru_black.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/eng_white.png */ "./src/assets/icons/eng_white.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/GitHub-Symbol.png */ "./src/assets/icons/GitHub-Symbol.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_11___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/icons/rs_school_js.svg */ "./src/assets/icons/rs_school_js.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_12___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/img/img_guess.jpg */ "./src/assets/img/img_guess.jpg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_13___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/img/hen_result.png */ "./src/assets/img/hen_result.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_14___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/svg/cross.svg */ "./src/assets/svg/cross.svg"), __webpack_require__.b);
...
/******/ })()
;
//# sourceMappingURL=bundle81d6c9dcc5aac742fc53.js.map