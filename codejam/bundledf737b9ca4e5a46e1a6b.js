...
function getTileMoved(iOfTileClicked, jOfTileClicked, iOfSpace, jOfSpace) {
  ...
  numberMatrix[iOfTileClicked][jOfTileClicked] = maxNumber; //  ctx.fillStyle = '#929699';
  ...
  setInterval(function () {
    ...
    if (position !== tileSize + 1) {
      ...
      ctx.font = "".concat(fontSize, "px san-serif ");
      ctx.textAlign = 'center';
      ctx.fillText("".concat(numberOfClickedTile), 10 + jOfTileClicked * (tileSize + 1) + tileSize / 2 - position * (jOfTileClicked - jOfSpace), 10 + iOfTileClicked * (tileSize + 1) + tileSize / 2 + fontSize / 3 - position * (iOfTileClicked - iOfSpace));
    }
  }, 10);
  ctx.fillStyle = '#929699';
  ctx.fillRect(10 + jOfTileClicked * (tileSize + 1), 10 + iOfTileClicked * (tileSize + 1), tileSize, tileSize);
...
function getLocalStorage() {
  bestResults = localStorage.getItem('bestResults').split(',').map(function (e) {
    return Number(e);
  });
...
/******/ })()
;
//# sourceMappingURL=bundledf737b9ca4e5a46e1a6b.js.map