  ...
  for (var i = 0; i < a; i++) {
    for (var j = 0; j < a; j++) {
      ...
      if (numberOfTile === size) {
        ...
        ctx.fillText("".concat(numberOfTile), 10 + j * 70 + 69 / 2, 10 + i * 70 + 69 / 2 + 16);
      }
    }
  }
...
/* harmony import */ var _getBody__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getBody */ "./src/getBody.js");
/* harmony import */ var _getMousePosition__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getMousePosition */ "./src/getMousePosition.js");
/* harmony import */ var _getTilesAgain__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./getTilesAgain */ "./src/getTilesAgain.js");
...
(0,_getBody__WEBPACK_IMPORTED_MODULE_3__["default"])(a, numberMatrix); //timer
...
buttonShuffle.addEventListener('click', function () {
  ...
  (0,_getTilesAgain__WEBPACK_IMPORTED_MODULE_5__["default"])(canvas, a, numberMatrix);
...
canvas.addEventListener("mousedown", function (e) {
  if (!buttonPause.classList.contains('on_pause')) {
    var position = (0,_getMousePosition__WEBPACK_IMPORTED_MODULE_4__["default"])(canvas, e);
    var iOfTileClicked = position.i;
    var jOfTileClicked = position.j;
    var ctx = canvas.getContext('2d');
    ...
    if (jOfTileClicked + 1 < a) {
      if (numberMatrix[iOfTileClicked][jOfTileClicked + 1] === maxNumber) {
        ...
        ctx.font = '48px san-serif';
        ctx.textAlign = 'center';
        ctx.fillText("".concat(numberOfClickedTile), 10 + (jOfTileClicked + 1) * 70 + 69 / 2, 10 + iOfTileClicked * 70 + 69 / 2 + 16);
        counter += 1;
    ...
    if (jOfTileClicked - 1 >= 0) {
      if (numberMatrix[iOfTileClicked][jOfTileClicked - 1] === maxNumber) {
        var _numberOfClickedTile = numberMatrix[iOfTileClicked][jOfTileClicked];
        numberMatrix[iOfTileClicked][jOfTileClicked] = maxNumber;
        ctx.fillStyle = '#929699';
        ctx.fillRect(10 + jOfTileClicked * 70, 10 + iOfTileClicked * 70, 69, 69);
        numberMatrix[iOfTileClicked][jOfTileClicked - 1] = _numberOfClickedTile;
        ctx.fillStyle = '#fcda69';
        ctx.fillRect(10 + (jOfTileClicked - 1) * 70, 10 + iOfTileClicked * 70, 69, 69);
        ctx.fillStyle = '#333B41';
        ctx.font = '48px san-serif';
        ctx.textAlign = 'center';
        ctx.fillText("".concat(_numberOfClickedTile), 10 + (jOfTileClicked - 1) * 70 + 69 / 2, 10 + iOfTileClicked * 70 + 69 / 2 + 16);
        counter += 1;
        moves.innerHTML = "Moves: ".concat(counter);
    ...
    if (iOfTileClicked + 1 < a) {
      if (numberMatrix[iOfTileClicked + 1][jOfTileClicked] === maxNumber) {
        var _numberOfClickedTile2 = numberMatrix[iOfTileClicked][jOfTileClicked];
        numberMatrix[iOfTileClicked][jOfTileClicked] = maxNumber;
        ctx.fillStyle = '#929699';
        ctx.fillRect(10 + jOfTileClicked * 70, 10 + iOfTileClicked * 70, 69, 69);
        numberMatrix[iOfTileClicked + 1][jOfTileClicked] = _numberOfClickedTile2;
        ctx.fillStyle = '#fcda69';
        ctx.fillRect(10 + jOfTileClicked * 70, 10 + (iOfTileClicked + 1) * 70, 69, 69);
        ctx.fillStyle = '#333B41';
        ctx.font = '48px san-serif';
        ctx.textAlign = 'center';
        ctx.fillText("".concat(_numberOfClickedTile2), 10 + jOfTileClicked * 70 + 69 / 2, 10 + (iOfTileClicked + 1) * 70 + 69 / 2 + 16);
        counter += 1;
        moves.innerHTML = "Moves: ".concat(counter);
    ...
    if (iOfTileClicked - 1 >= 0) {
      if (numberMatrix[iOfTileClicked - 1][jOfTileClicked] === maxNumber) {
        var _numberOfClickedTile3 = numberMatrix[iOfTileClicked][jOfTileClicked];
        numberMatrix[iOfTileClicked][jOfTileClicked] = maxNumber;
        ctx.fillStyle = '#929699';
        ctx.fillRect(10 + jOfTileClicked * 70, 10 + iOfTileClicked * 70, 69, 69);
        numberMatrix[iOfTileClicked - 1][jOfTileClicked] = _numberOfClickedTile3;
        ctx.fillStyle = '#fcda69';
        ctx.fillRect(10 + jOfTileClicked * 70, 10 + (iOfTileClicked - 1) * 70, 69, 69);
        ctx.fillStyle = '#333B41';
        ctx.font = '48px san-serif';
        ctx.textAlign = 'center';
        ctx.fillText("".concat(_numberOfClickedTile3), 10 + jOfTileClicked * 70 + 69 / 2, 10 + (iOfTileClicked - 1) * 70 + 69 / 2 + 16);
        counter += 1;
        moves.innerHTML = "Moves: ".concat(counter);
...
/******/ })()
;
//# sourceMappingURL=bundlefeacbbb676099dfb6b38.js.map